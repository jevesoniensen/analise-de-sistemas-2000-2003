...
public class Tela extends JFrame implements ActionListener
{
	...
	public void inicializaPanelInferior()
	{
		...
		pnInferior.add(new JLabel("Caminho Crítico: "));
	...
	public void inicializaPanelDir()
	{
		...
		pnDir = new JPanel();
		lbTarefas = new JLabel("Tempo Mínimo",JLabel.CENTER);		
	...
	{
		Calculos calculo = new Calculos(pnDrop.vecTempoTarefas,pnDrop.numComponentes);				
