...
public class DropPanel extends JPanel implements DropTargetListener,MouseListener,ActionListener
{
	...
	{				
		...
		{	
    		...
    		Calculos calculo = new Calculos(vecTempoTarefas,numComponentes,false);				
			aux1 = calculo.retornaCiclos();
			if(aux1 != null)
			{
				           aux2   =  new Vector();
				int        value  = 0,
				...
				{
					value = ((Integer)aux1.elementAt(i)).intValue() + 1 ;
					v_test = ((Integer)aux1.elementAt(aux1.size() -1)).intValue() + 1 ;
					if(value == v_test)
						adiciona = true;
				...
				new Alerta(jfPai,"DeadLock", true, aux2);	
				System.out.println("teste" + aux2.toString());
			}
		}
		else
		{
