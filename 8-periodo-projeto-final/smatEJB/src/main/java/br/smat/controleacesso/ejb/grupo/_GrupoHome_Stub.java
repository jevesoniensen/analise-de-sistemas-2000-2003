...
public class _GrupoHome_Stub extends Stub implements GrupoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.controleacesso.ejb.grupo.GrupoHome:0000000000000000", 
    ...
    public Grupo findByPrimaryKey(GrupoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Grupo) in.read_Object(Grupo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.controleacesso.ejb.grupo.GrupoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                GrupoKey arg0Copy = (GrupoKey) Util.copyObject(arg0,_orb());
                Grupo result = ((br.smat.controleacesso.ejb.grupo.GrupoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Grupo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAll() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAll",br.smat.controleacesso.ejb.grupo.GrupoHome.class);
            if (so == null) {
                return findAll();
            }
            try {
                Collection result = ((br.smat.controleacesso.ejb.grupo.GrupoHome)so.servant).findAll();
    ...
    public Grupo create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.controleacesso.ejb.grupo.GrupoHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Grupo result = ((br.smat.controleacesso.ejb.grupo.GrupoHome)so.servant).create(arg0);
                return (Grupo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
