...
public class _Grupo_Stub extends Stub implements Grupo {
    ...
    public int getGrupo() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_grupo_", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_grupo_",br.smat.controleacesso.ejb.grupo.Grupo.class);
            if (so == null) {
                return getGrupo();
            }
            try {
                return ((br.smat.controleacesso.ejb.grupo.Grupo)so.servant).getGrupo();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getNome() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_nome",br.smat.controleacesso.ejb.grupo.Grupo.class);
            if (so == null) {
                return getNome();
            }
            try {
                return ((br.smat.controleacesso.ejb.grupo.Grupo)so.servant).getNome();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setGrupo(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_set_grupo_", true);
                    out.write_long(arg0);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("_set_grupo_",br.smat.controleacesso.ejb.grupo.Grupo.class);
            if (so == null) {
                setGrupo(arg0);
                return;
            }
            try {
                ((br.smat.controleacesso.ejb.grupo.Grupo)so.servant).setGrupo(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setNome(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_nome",br.smat.controleacesso.ejb.grupo.Grupo.class);
            if (so == null) {
                setNome(arg0);
                return;
            }
            try {
                ((br.smat.controleacesso.ejb.grupo.Grupo)so.servant).setNome(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
