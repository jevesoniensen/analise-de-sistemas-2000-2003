...
/**
 * EJSRemoteBMPModuloHome_17db6578
 * @generated
 */
public class EJSRemoteBMPModuloHome_17db6578
	extends EJSWrapper
	implements br.smat.controleacesso.ejb.modulo.ModuloHome {
	/**
	 * EJSRemoteBMPModuloHome_17db6578
	 * @generated
	 */
	public EJSRemoteBMPModuloHome_17db6578() throws java.rmi.RemoteException {
		super();
	}
	/**
	 * create
	...
	public br.smat.controleacesso.ejb.modulo.Modulo create(
		...
		br.smat.controleacesso.ejb.modulo.Modulo _EJS_result = null;
		try {
			br
				.smat
				.controleacesso
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.create(paginaDefault, nome, moduloPai, estrutura);
	 ...
	 * @generated
	 */
	public br.smat.controleacesso.ejb.modulo.Modulo findByPrimaryKey(
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllModulos();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
