...
public class _ModuloHome_Stub extends Stub implements ModuloHome {
    ...
    public Modulo create(int arg0, String arg1, int arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Modulo) in.read_Object(Modulo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.controleacesso.ejb.modulo.ModuloHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                Modulo result = ((br.smat.controleacesso.ejb.modulo.ModuloHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (Modulo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Modulo findByPrimaryKey(ModuloKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.controleacesso.ejb.modulo.ModuloHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ModuloKey arg0Copy = (ModuloKey) Util.copyObject(arg0,_orb());
                Modulo result = ((br.smat.controleacesso.ejb.modulo.ModuloHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Modulo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllModulos() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllModulos", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllModulos",br.smat.controleacesso.ejb.modulo.ModuloHome.class);
            if (so == null) {
                return findAllModulos();
            }
            try {
                Collection result = ((br.smat.controleacesso.ejb.modulo.ModuloHome)so.servant).findAllModulos();
