...
public class _EJSRemoteBMPPaginaHome_81265800_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPPaginaHome_81265800 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPPaginaHome_81265800) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 14: 
                    if (method.equals("findAllPaginas")) {
                        return findAllPaginas(in, reply);
                    }
                case 15: 
                ...
                case 18: 
                    if (method.equals("findPermisaoPagina")) {
                        return findPermisaoPagina(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findAllPaginas(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Collection result;
        try {
            result = target.findAllPaginas();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findPermisaoPagina(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        Pagina result;
        try {
            result = target.findPermisaoPagina(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
