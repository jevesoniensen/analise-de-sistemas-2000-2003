...
public class _EJSRemoteBMPPagina_81265800_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPPagina_81265800 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:br.smat.controleacesso.ejb.pagina.Pagina:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPPagina_81265800) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 12: 
                    if (method.equals("_get_pagina_")) {
                        return _get_pagina_(in, reply);
    ...
    private org.omg.CORBA.portable.OutputStream _get_pagina_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getPagina();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
