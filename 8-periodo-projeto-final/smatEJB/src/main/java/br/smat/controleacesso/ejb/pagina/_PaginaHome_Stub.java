...
public class _PaginaHome_Stub extends Stub implements PaginaHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.controleacesso.ejb.pagina.PaginaHome:0000000000000000", 
    ...
    public Pagina create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Pagina) in.read_Object(Pagina.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.controleacesso.ejb.pagina.PaginaHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Pagina result = ((br.smat.controleacesso.ejb.pagina.PaginaHome)so.servant).create(arg0);
                return (Pagina)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Pagina findByPrimaryKey(PaginaKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.controleacesso.ejb.pagina.PaginaHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PaginaKey arg0Copy = (PaginaKey) Util.copyObject(arg0,_orb());
                Pagina result = ((br.smat.controleacesso.ejb.pagina.PaginaHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Pagina)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllPaginas() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllPaginas", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllPaginas",br.smat.controleacesso.ejb.pagina.PaginaHome.class);
            if (so == null) {
                return findAllPaginas();
            }
            try {
                Collection result = ((br.smat.controleacesso.ejb.pagina.PaginaHome)so.servant).findAllPaginas();
    ...
    public Pagina findPermisaoPagina(int arg0, int arg1) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findPermisaoPagina", true);
                    out.write_long(arg0);
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Pagina) in.read_Object(Pagina.class);
                    ...
                    return findPermisaoPagina(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findPermisaoPagina",br.smat.controleacesso.ejb.pagina.PaginaHome.class);
            if (so == null) {
                return findPermisaoPagina(arg0, arg1);
            }
            try {
                Pagina result = ((br.smat.controleacesso.ejb.pagina.PaginaHome)so.servant).findPermisaoPagina(arg0, arg1);
                return (Pagina)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
