...
public class _Pagina_Stub extends Stub implements Pagina {
    ...
    public String getNome() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_nome",br.smat.controleacesso.ejb.pagina.Pagina.class);
            if (so == null) {
                return getNome();
            }
            try {
                return ((br.smat.controleacesso.ejb.pagina.Pagina)so.servant).getNome();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getPagina() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_pagina_", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_pagina_",br.smat.controleacesso.ejb.pagina.Pagina.class);
            if (so == null) {
                return getPagina();
            }
            try {
                return ((br.smat.controleacesso.ejb.pagina.Pagina)so.servant).getPagina();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setNome(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_nome",br.smat.controleacesso.ejb.pagina.Pagina.class);
            if (so == null) {
                setNome(arg0);
                return;
            }
            try {
                ((br.smat.controleacesso.ejb.pagina.Pagina)so.servant).setNome(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
