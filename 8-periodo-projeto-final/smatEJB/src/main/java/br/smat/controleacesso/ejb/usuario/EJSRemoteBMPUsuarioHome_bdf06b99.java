...
/**
 * EJSRemoteBMPUsuarioHome_bdf06b99
 * @generated
 */
public class EJSRemoteBMPUsuarioHome_bdf06b99
	extends EJSWrapper
	implements br.smat.controleacesso.ejb.usuario.UsuarioHome {
	/**
	 * EJSRemoteBMPUsuarioHome_bdf06b99
	 * @generated
	 */
	public EJSRemoteBMPUsuarioHome_bdf06b99() throws java.rmi.RemoteException {
		super();
	}
	/**
	 * create
	...
	public br.smat.controleacesso.ejb.usuario.Usuario create(
		...
		br.smat.controleacesso.ejb.usuario.Usuario _EJS_result = null;
		try {
			br
				.smat
				.controleacesso
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, senha, agenteSaude);
		...
		try {
			br
				...
				(
					...
					1,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findByNomeSenha(nome, senha);
	 ...
	 * @generated
	 */
	public br.smat.controleacesso.ejb.usuario.Usuario findByPrimaryKey(
