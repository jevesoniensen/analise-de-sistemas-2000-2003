...
public class _UsuarioHome_Stub extends Stub implements UsuarioHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.controleacesso.ejb.usuario.UsuarioHome:0000000000000000", 
    ...
    public Usuario findByPrimaryKey(UsuarioKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Usuario) in.read_Object(Usuario.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.controleacesso.ejb.usuario.UsuarioHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                UsuarioKey arg0Copy = (UsuarioKey) Util.copyObject(arg0,_orb());
                Usuario result = ((br.smat.controleacesso.ejb.usuario.UsuarioHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Usuario)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Usuario findByNomeSenha(String arg0, String arg1) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    return findByNomeSenha(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findByNomeSenha",br.smat.controleacesso.ejb.usuario.UsuarioHome.class);
            if (so == null) {
                return findByNomeSenha(arg0, arg1);
            }
            try {
                Usuario result = ((br.smat.controleacesso.ejb.usuario.UsuarioHome)so.servant).findByNomeSenha(arg0, arg1);
                return (Usuario)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
    ...
    public Usuario create(String arg0, String arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.controleacesso.ejb.usuario.UsuarioHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                Usuario result = ((br.smat.controleacesso.ejb.usuario.UsuarioHome)so.servant).create(arg0, arg1, arg2);
                return (Usuario)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAll() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("findAll",br.smat.controleacesso.ejb.usuario.UsuarioHome.class);
            if (so == null) {
                return findAll();
            }
            try {
                Collection result = ((br.smat.controleacesso.ejb.usuario.UsuarioHome)so.servant).findAll();
