...
/**
 * EJSRemoteBMPUsuarioGrupoHome_e50a2bd2
 * @generated
 */
public class EJSRemoteBMPUsuarioGrupoHome_e50a2bd2
	extends EJSWrapper
	implements br.smat.controleacesso.ejb.usuariogrupo.UsuarioGrupoHome {
	/**
	 * EJSRemoteBMPUsuarioGrupoHome_e50a2bd2
	 * @generated
	 */
	public EJSRemoteBMPUsuarioGrupoHome_e50a2bd2()
	...
	public br.smat.controleacesso.ejb.usuariogrupo.UsuarioGrupo create(
		...
		br.smat.controleacesso.ejb.usuariogrupo.UsuarioGrupo _EJS_result = null;
		try {
			br
				.smat
				.controleacesso
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(grupo, usuario);
		...
		try {
			br
				...
				(
					...
					3,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllByGrupo(grupo);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
		...
		try {
			br
				...
				(
					...
					4,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllByUsuario(usuario);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
