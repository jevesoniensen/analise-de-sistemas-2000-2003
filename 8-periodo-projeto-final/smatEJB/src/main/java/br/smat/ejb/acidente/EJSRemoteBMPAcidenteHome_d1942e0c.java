...
/**
 * EJSRemoteBMPAcidenteHome_d1942e0c
 * @generated
 */
public class EJSRemoteBMPAcidenteHome_d1942e0c
	extends EJSWrapper
	implements br.smat.ejb.acidente.AcidenteHome {
	/**
	 * EJSRemoteBMPAcidenteHome_d1942e0c
	 * @generated
	 */
	public EJSRemoteBMPAcidenteHome_d1942e0c()
	...
	public br.smat.ejb.acidente.Acidente findByPrimaryKey(
		...
		br.smat.ejb.acidente.Acidente _EJS_result = null;
		try {
		...
		try {
			br.smat.ejb.acidente.EJSBMPAcidenteHomeBean_d1942e0c _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllAcidentes();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
