...
/**
 * EJSRemoteBMPAgenteCausadorHome_f7077ead
 * @generated
 */
public class EJSRemoteBMPAgenteCausadorHome_f7077ead
	extends EJSWrapper
	implements br.smat.ejb.agentecausador.AgenteCausadorHome {
	/**
	 * EJSRemoteBMPAgenteCausadorHome_f7077ead
	 * @generated
	 */
	public EJSRemoteBMPAgenteCausadorHome_f7077ead()
	...
	public br.smat.ejb.agentecausador.AgenteCausador findByPrimaryKey(
		...
		br.smat.ejb.agentecausador.AgenteCausador _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllAgentesCausadores();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
		...
		try {
			br
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.create(nome, descricao, agenteCausadorPai);
		...
		try {
			br
				...
				(
					...
					3,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllAgentesCausadores(pai);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
		...
		try {
			br
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.findAllAgentesCausadoresNot(
					agenteCausador,
					agenteCausadorPai);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
