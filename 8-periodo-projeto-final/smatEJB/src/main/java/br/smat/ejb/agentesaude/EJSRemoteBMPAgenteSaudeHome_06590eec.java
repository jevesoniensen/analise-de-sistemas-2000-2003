...
/**
 * EJSRemoteBMPAgenteSaudeHome_06590eec
 * @generated
 */
public class EJSRemoteBMPAgenteSaudeHome_06590eec
	extends EJSWrapper
	implements br.smat.ejb.agentesaude.AgenteSaudeHome {
	/**
	 * EJSRemoteBMPAgenteSaudeHome_06590eec
	 * @generated
	 */
	public EJSRemoteBMPAgenteSaudeHome_06590eec()
	...
	public br.smat.ejb.agentesaude.AgenteSaude create(
		...
		br.smat.ejb.agentesaude.AgenteSaude _EJS_result = null;
		try {
			br
				.smat
				.ejb
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, email, regional);
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllAgentesSaude();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
