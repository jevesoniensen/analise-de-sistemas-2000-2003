...
public class _AgenteSaudeHome_Stub extends Stub implements AgenteSaudeHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.agentesaude.AgenteSaudeHome:0000000000000000", 
    ...
    public AgenteSaude create(String arg0, String arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg2);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AgenteSaude) in.read_Object(AgenteSaude.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.agentesaude.AgenteSaudeHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                AgenteSaude result = ((br.smat.ejb.agentesaude.AgenteSaudeHome)so.servant).create(arg0, arg1, arg2);
                return (AgenteSaude)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public AgenteSaude findByPrimaryKey(AgenteSaudeKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.agentesaude.AgenteSaudeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AgenteSaudeKey arg0Copy = (AgenteSaudeKey) Util.copyObject(arg0,_orb());
                AgenteSaude result = ((br.smat.ejb.agentesaude.AgenteSaudeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (AgenteSaude)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllAgentesSaude() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllAgentesSaude", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllAgentesSaude",br.smat.ejb.agentesaude.AgenteSaudeHome.class);
            if (so == null) {
                return findAllAgentesSaude();
            }
            try {
                Collection result = ((br.smat.ejb.agentesaude.AgenteSaudeHome)so.servant).findAllAgentesSaude();
