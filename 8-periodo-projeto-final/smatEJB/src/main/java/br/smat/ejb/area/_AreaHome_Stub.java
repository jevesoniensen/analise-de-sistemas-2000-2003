...
public class _AreaHome_Stub extends Stub implements AreaHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.area.AreaHome:0000000000000000", 
    ...
    public Area create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Area) in.read_Object(Area.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.area.AreaHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Area result = ((br.smat.ejb.area.AreaHome)so.servant).create(arg0);
                return (Area)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Area findByPrimaryKey(AreaKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.area.AreaHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                AreaKey arg0Copy = (AreaKey) Util.copyObject(arg0,_orb());
                Area result = ((br.smat.ejb.area.AreaHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Area)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllAreas() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllAreas", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllAreas",br.smat.ejb.area.AreaHome.class);
            if (so == null) {
                return findAllAreas();
            }
            try {
                Collection result = ((br.smat.ejb.area.AreaHome)so.servant).findAllAreas();
