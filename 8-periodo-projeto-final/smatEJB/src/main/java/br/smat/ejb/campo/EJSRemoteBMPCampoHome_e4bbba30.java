...
/**
 * EJSRemoteBMPCampoHome_e4bbba30
 * @generated
 */
public class EJSRemoteBMPCampoHome_e4bbba30
	extends EJSWrapper
	implements br.smat.ejb.campo.CampoHome {
	/**
	 * EJSRemoteBMPCampoHome_e4bbba30
	 * @generated
	 */
	public EJSRemoteBMPCampoHome_e4bbba30() throws java.rmi.RemoteException {
		super();
	}
	/**
	 * findByPrimaryKey
	...
	public br.smat.ejb.campo.Campo findByPrimaryKey(
		...
		br.smat.ejb.campo.Campo _EJS_result = null;
		try {
		...
		try {
			br.smat.ejb.campo.EJSBMPCampoHomeBean_e4bbba30 _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllCampos();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
		...
		try {
			br.smat.ejb.campo.EJSBMPCampoHomeBean_e4bbba30 _EJS_beanRef =
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(tabela, coluna, pai, nome, label);
		...
		try {
			br.smat.ejb.campo.EJSBMPCampoHomeBean_e4bbba30 _EJS_beanRef =
				(
					...
					3,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllCampos(campo1);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
