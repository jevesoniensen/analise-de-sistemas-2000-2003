...
/**
 * EJSRemoteBMPDadoInvestigacaoHome_2a51dca9
 * @generated
 */
public class EJSRemoteBMPDadoInvestigacaoHome_2a51dca9
	extends EJSWrapper
	implements br.smat.ejb.dadoinvestigacao.DadoInvestigacaoHome {
	/**
	 * EJSRemoteBMPDadoInvestigacaoHome_2a51dca9
	 * @generated
	 */
	public EJSRemoteBMPDadoInvestigacaoHome_2a51dca9()
	...
	public br.smat.ejb.dadoinvestigacao.DadoInvestigacao findByPrimaryKey(
		...
		br.smat.ejb.dadoinvestigacao.DadoInvestigacao _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.findAllDadoInvestigacao(dadoInvestigacao);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
