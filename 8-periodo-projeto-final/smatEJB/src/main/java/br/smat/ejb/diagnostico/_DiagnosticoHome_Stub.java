...
public class _DiagnosticoHome_Stub extends Stub implements DiagnosticoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.diagnostico.DiagnosticoHome:0000000000000000", 
    ...
    public Diagnostico create(String arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Diagnostico) in.read_Object(Diagnostico.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.diagnostico.DiagnosticoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                Diagnostico result = ((br.smat.ejb.diagnostico.DiagnosticoHome)so.servant).create(arg0, arg1);
                return (Diagnostico)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Diagnostico findByPrimaryKey(DiagnosticoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.diagnostico.DiagnosticoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                DiagnosticoKey arg0Copy = (DiagnosticoKey) Util.copyObject(arg0,_orb());
                Diagnostico result = ((br.smat.ejb.diagnostico.DiagnosticoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Diagnostico)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllDiagnosticos() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllDiagnosticos", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllDiagnosticos",br.smat.ejb.diagnostico.DiagnosticoHome.class);
            if (so == null) {
                return findAllDiagnosticos();
            }
            try {
                Collection result = ((br.smat.ejb.diagnostico.DiagnosticoHome)so.servant).findAllDiagnosticos();
