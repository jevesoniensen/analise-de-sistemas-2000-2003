...
/**
 * EJSRemoteBMPEmitenteHome_2640cd31
 * @generated
 */
public class EJSRemoteBMPEmitenteHome_2640cd31
	extends EJSWrapper
	implements br.smat.ejb.emitente.EmitenteHome {
	/**
	 * EJSRemoteBMPEmitenteHome_2640cd31
	 * @generated
	 */
	public EJSRemoteBMPEmitenteHome_2640cd31()
	...
	public br.smat.ejb.emitente.Emitente create(java.lang.String nome)
		...
		br.smat.ejb.emitente.Emitente _EJS_result = null;
		try {
		...
		try {
			br.smat.ejb.emitente.EJSBMPEmitenteHomeBean_2640cd31 _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllEmitentes();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
