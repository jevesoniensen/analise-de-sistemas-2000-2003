...
public class _EJSRemoteBMPEmitenteHome_2640cd31_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPEmitenteHome_2640cd31 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPEmitenteHome_2640cd31) target;
    }
        ...
        try {
            ...
            switch (method.charAt(0)) {
                ...
                case 102: 
                    ...
                    } else if (method.equals("findAllEmitentes")) {
                        return findAllEmitentes(in, reply);
                    }
                case 114: 
    ...
    private org.omg.CORBA.portable.OutputStream findAllEmitentes(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Collection result;
        try {
            result = target.findAllEmitentes();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
