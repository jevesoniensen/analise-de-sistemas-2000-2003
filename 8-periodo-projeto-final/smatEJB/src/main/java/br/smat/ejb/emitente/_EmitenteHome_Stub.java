...
public class _EmitenteHome_Stub extends Stub implements EmitenteHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.emitente.EmitenteHome:0000000000000000", 
    ...
    public Emitente create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Emitente) in.read_Object(Emitente.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.emitente.EmitenteHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Emitente result = ((br.smat.ejb.emitente.EmitenteHome)so.servant).create(arg0);
                return (Emitente)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Emitente findByPrimaryKey(EmitenteKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.emitente.EmitenteHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                EmitenteKey arg0Copy = (EmitenteKey) Util.copyObject(arg0,_orb());
                Emitente result = ((br.smat.ejb.emitente.EmitenteHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Emitente)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllEmitentes() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllEmitentes", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllEmitentes",br.smat.ejb.emitente.EmitenteHome.class);
            if (so == null) {
                return findAllEmitentes();
            }
            try {
                Collection result = ((br.smat.ejb.emitente.EmitenteHome)so.servant).findAllEmitentes();
