...
public class _EmpregadorHome_Stub extends Stub implements EmpregadorHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.empregador.EmpregadorHome:0000000000000000", 
    ...
    public Empregador create(int arg0, int arg1, int arg2, String arg3, String arg4, int arg5, String arg6, String arg7, String arg8, String arg9) throws CreateException, RemoteException, SQLException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Empregador) in.read_Object(Empregador.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.empregador.EmpregadorHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
            }
            try {
                Empregador result = ((br.smat.ejb.empregador.EmpregadorHome)so.servant).create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9);
                return (Empregador)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Empregador findByPrimaryKey(EmpregadorKey arg0) throws FinderException, RemoteException, SQLException, Exception {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.empregador.EmpregadorHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                EmpregadorKey arg0Copy = (EmpregadorKey) Util.copyObject(arg0,_orb());
                Empregador result = ((br.smat.ejb.empregador.EmpregadorHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Empregador)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllEmpregadores() throws FinderException, RemoteException, Exception {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllEmpregadores", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllEmpregadores",br.smat.ejb.empregador.EmpregadorHome.class);
            if (so == null) {
                return findAllEmpregadores();
            }
            try {
                Collection result = ((br.smat.ejb.empregador.EmpregadorHome)so.servant).findAllEmpregadores();
