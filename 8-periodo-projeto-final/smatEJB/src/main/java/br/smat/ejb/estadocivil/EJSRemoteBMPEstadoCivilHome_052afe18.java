...
/**
 * EJSRemoteBMPEstadoCivilHome_052afe18
 * @generated
 */
public class EJSRemoteBMPEstadoCivilHome_052afe18
	extends EJSWrapper
	implements br.smat.ejb.estadocivil.EstadoCivilHome {
	/**
	 * EJSRemoteBMPEstadoCivilHome_052afe18
	 * @generated
	 */
	public EJSRemoteBMPEstadoCivilHome_052afe18()
	...
	public br.smat.ejb.estadocivil.EstadoCivil findByPrimaryKey(
		...
		br.smat.ejb.estadocivil.EstadoCivil _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllEstadosCivis();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
