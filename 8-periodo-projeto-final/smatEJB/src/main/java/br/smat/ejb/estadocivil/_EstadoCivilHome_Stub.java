...
public class _EstadoCivilHome_Stub extends Stub implements EstadoCivilHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.estadocivil.EstadoCivilHome:0000000000000000", 
    ...
    public EstadoCivil create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (EstadoCivil) in.read_Object(EstadoCivil.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.estadocivil.EstadoCivilHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                EstadoCivil result = ((br.smat.ejb.estadocivil.EstadoCivilHome)so.servant).create(arg0);
                return (EstadoCivil)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public EstadoCivil findByPrimaryKey(EstadoCivilKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.estadocivil.EstadoCivilHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                EstadoCivilKey arg0Copy = (EstadoCivilKey) Util.copyObject(arg0,_orb());
                EstadoCivil result = ((br.smat.ejb.estadocivil.EstadoCivilHome)so.servant).findByPrimaryKey(arg0Copy);
                return (EstadoCivil)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllEstadosCivis() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllEstadosCivis", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllEstadosCivis",br.smat.ejb.estadocivil.EstadoCivilHome.class);
            if (so == null) {
                return findAllEstadosCivis();
            }
            try {
                Collection result = ((br.smat.ejb.estadocivil.EstadoCivilHome)so.servant).findAllEstadosCivis();
