...
public class _EstadoCivil_Stub extends Stub implements EstadoCivil {
    ...
    public int getEstadoCivil() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_estadoCivil_", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_estadoCivil_",br.smat.ejb.estadocivil.EstadoCivil.class);
            if (so == null) {
                return getEstadoCivil();
            }
            try {
                return ((br.smat.ejb.estadocivil.EstadoCivil)so.servant).getEstadoCivil();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getNome() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_nome",br.smat.ejb.estadocivil.EstadoCivil.class);
            if (so == null) {
                return getNome();
            }
            try {
                return ((br.smat.ejb.estadocivil.EstadoCivil)so.servant).getNome();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setNome(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_nome",br.smat.ejb.estadocivil.EstadoCivil.class);
            if (so == null) {
                setNome(arg0);
                return;
            }
            try {
                ((br.smat.ejb.estadocivil.EstadoCivil)so.servant).setNome(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setEstadoCivil(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_set_estadoCivil_", true);
                    out.write_long(arg0);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("_set_estadoCivil_",br.smat.ejb.estadocivil.EstadoCivil.class);
            if (so == null) {
                setEstadoCivil(arg0);
                return;
            }
            try {
                ((br.smat.ejb.estadocivil.EstadoCivil)so.servant).setEstadoCivil(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
