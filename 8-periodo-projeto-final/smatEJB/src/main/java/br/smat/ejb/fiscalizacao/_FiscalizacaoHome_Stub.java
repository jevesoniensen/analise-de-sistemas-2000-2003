...
public class _FiscalizacaoHome_Stub extends Stub implements FiscalizacaoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.fiscalizacao.FiscalizacaoHome:0000000000000000", 
    ...
    public Fiscalizacao findByPrimaryKey(FiscalizacaoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Fiscalizacao) in.read_Object(Fiscalizacao.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.fiscalizacao.FiscalizacaoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                FiscalizacaoKey arg0Copy = (FiscalizacaoKey) Util.copyObject(arg0,_orb());
                Fiscalizacao result = ((br.smat.ejb.fiscalizacao.FiscalizacaoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Fiscalizacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllFiscalizacao() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllFiscalizacao", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllFiscalizacao",br.smat.ejb.fiscalizacao.FiscalizacaoHome.class);
            if (so == null) {
                return findAllFiscalizacao();
            }
            try {
                Collection result = ((br.smat.ejb.fiscalizacao.FiscalizacaoHome)so.servant).findAllFiscalizacao();
    ...
    public Fiscalizacao create(int arg0, int arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.fiscalizacao.FiscalizacaoHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                Fiscalizacao result = ((br.smat.ejb.fiscalizacao.FiscalizacaoHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (Fiscalizacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
