...
/**
 * EJSLocalBMPFonteHome_d4a4cd42
 * @generated
 */
public class EJSLocalBMPFonteHome_d4a4cd42
	extends EJSLocalWrapper
	implements br.smat.ejb.fonte.FonteLocalHome {
	/**
	 * EJSLocalBMPFonteHome_d4a4cd42
	 * @generated
	 */
	public EJSLocalBMPFonteHome_d4a4cd42() {
		super();
	}
	/**
	 * create
	 * @generated
	 */
	public br.smat.ejb.fonte.FonteLocal create(java.lang.String nome)
		throws javax.ejb.CreateException {
		EJSDeployedSupport _EJS_s = container.getEJSDeployedSupport(this);
		br.smat.ejb.fonte.FonteLocal _EJS_result = null;
		try {
		...
		try {
			br.smat.ejb.fonte.EJSBMPFonteHomeBean_d4a4cd42 _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllFontes_Local();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
