...
public class _FonteHome_Stub extends Stub implements FonteHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.fonte.FonteHome:0000000000000000", 
    ...
    public Fonte create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Fonte) in.read_Object(Fonte.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.fonte.FonteHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                Fonte result = ((br.smat.ejb.fonte.FonteHome)so.servant).create(arg0);
                return (Fonte)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Fonte findByPrimaryKey(FonteKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.fonte.FonteHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                FonteKey arg0Copy = (FonteKey) Util.copyObject(arg0,_orb());
                Fonte result = ((br.smat.ejb.fonte.FonteHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Fonte)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllFontes() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllFontes", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllFontes",br.smat.ejb.fonte.FonteHome.class);
            if (so == null) {
                return findAllFontes();
            }
            try {
                Collection result = ((br.smat.ejb.fonte.FonteHome)so.servant).findAllFontes();
