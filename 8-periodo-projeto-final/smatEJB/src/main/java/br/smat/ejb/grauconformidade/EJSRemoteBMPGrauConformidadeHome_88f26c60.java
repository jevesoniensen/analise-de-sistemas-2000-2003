...
/**
 * EJSRemoteBMPGrauConformidadeHome_88f26c60
 * @generated
 */
public class EJSRemoteBMPGrauConformidadeHome_88f26c60
	extends EJSWrapper
	implements br.smat.ejb.grauconformidade.GrauConformidadeHome {
	/**
	 * EJSRemoteBMPGrauConformidadeHome_88f26c60
	 * @generated
	 */
	public EJSRemoteBMPGrauConformidadeHome_88f26c60()
	...
	public br.smat.ejb.grauconformidade.GrauConformidade create(
		...
		br.smat.ejb.grauconformidade.GrauConformidade _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllTipoAcidente();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
