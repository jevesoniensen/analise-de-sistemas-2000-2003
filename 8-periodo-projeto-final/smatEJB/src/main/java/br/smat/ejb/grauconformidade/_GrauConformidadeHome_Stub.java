...
public class _GrauConformidadeHome_Stub extends Stub implements GrauConformidadeHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.grauconformidade.GrauConformidadeHome:0000000000000000", 
    ...
    public GrauConformidade create(String arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (GrauConformidade) in.read_Object(GrauConformidade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.grauconformidade.GrauConformidadeHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                GrauConformidade result = ((br.smat.ejb.grauconformidade.GrauConformidadeHome)so.servant).create(arg0, arg1);
                return (GrauConformidade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public GrauConformidade findByPrimaryKey(GrauConformidadeKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.grauconformidade.GrauConformidadeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                GrauConformidadeKey arg0Copy = (GrauConformidadeKey) Util.copyObject(arg0,_orb());
                GrauConformidade result = ((br.smat.ejb.grauconformidade.GrauConformidadeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (GrauConformidade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTipoAcidente() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTipoAcidente", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllTipoAcidente",br.smat.ejb.grauconformidade.GrauConformidadeHome.class);
            if (so == null) {
                return findAllTipoAcidente();
            }
            try {
                Collection result = ((br.smat.ejb.grauconformidade.GrauConformidadeHome)so.servant).findAllTipoAcidente();
