...
/**
 * EJSRemoteBMPInvestigacaoHome_50a64b27
 * @generated
 */
public class EJSRemoteBMPInvestigacaoHome_50a64b27
	extends EJSWrapper
	implements br.smat.ejb.investigacao.InvestigacaoHome {
	/**
	 * EJSRemoteBMPInvestigacaoHome_50a64b27
	 * @generated
	 */
	public EJSRemoteBMPInvestigacaoHome_50a64b27()
	...
	public br.smat.ejb.investigacao.Investigacao create(
		...
		br.smat.ejb.investigacao.Investigacao _EJS_result = null;
		try {
			br
				.smat
				.ejb
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.create(agenteSaude, acidente, titulo, obsGerais);
		...
		try {
			br
				...
				(
					...
					3,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllInvestigacao();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
