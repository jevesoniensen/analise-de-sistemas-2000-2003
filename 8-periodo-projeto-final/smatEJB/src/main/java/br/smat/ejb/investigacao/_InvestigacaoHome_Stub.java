...
public class _InvestigacaoHome_Stub extends Stub implements InvestigacaoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.investigacao.InvestigacaoHome:0000000000000000", 
    ...
    public Investigacao findByPrimaryKey(InvestigacaoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Investigacao) in.read_Object(Investigacao.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.investigacao.InvestigacaoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                InvestigacaoKey arg0Copy = (InvestigacaoKey) Util.copyObject(arg0,_orb());
                Investigacao result = ((br.smat.ejb.investigacao.InvestigacaoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Investigacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllInvestigacao() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllInvestigacao", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllInvestigacao",br.smat.ejb.investigacao.InvestigacaoHome.class);
            if (so == null) {
                return findAllInvestigacao();
            }
            try {
                Collection result = ((br.smat.ejb.investigacao.InvestigacaoHome)so.servant).findAllInvestigacao();
    ...
    public Investigacao create(int arg0, int arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.investigacao.InvestigacaoHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                Investigacao result = ((br.smat.ejb.investigacao.InvestigacaoHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (Investigacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Investigacao findByAcidente(int arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByAcidente",br.smat.ejb.investigacao.InvestigacaoHome.class);
            if (so == null) {
                return findByAcidente(arg0);
            }
            try {
                Investigacao result = ((br.smat.ejb.investigacao.InvestigacaoHome)so.servant).findByAcidente(arg0);
                return (Investigacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
