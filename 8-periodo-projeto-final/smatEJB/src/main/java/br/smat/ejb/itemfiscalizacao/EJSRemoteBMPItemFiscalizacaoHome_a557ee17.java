...
/**
 * EJSRemoteBMPItemFiscalizacaoHome_a557ee17
 * @generated
 */
public class EJSRemoteBMPItemFiscalizacaoHome_a557ee17
	extends EJSWrapper
	implements br.smat.ejb.itemfiscalizacao.ItemFiscalizacaoHome {
	/**
	 * EJSRemoteBMPItemFiscalizacaoHome_a557ee17
	 * @generated
	 */
	public EJSRemoteBMPItemFiscalizacaoHome_a557ee17()
	...
	public br.smat.ejb.itemfiscalizacao.ItemFiscalizacao create(
		...
		br.smat.ejb.itemfiscalizacao.ItemFiscalizacao _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllItemFiscalizacao();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
