...
public class _EJSRemoteBMPItemFiscalizacao_a557ee17_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPItemFiscalizacao_a557ee17 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.itemfiscalizacao.ItemFiscalizacao:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPItemFiscalizacao_a557ee17) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 22: 
                    if (method.equals("_get_itemFiscalizacao_")) {
                        return _get_itemFiscalizacao_(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_itemFiscalizacao_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getItemFiscalizacao();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
