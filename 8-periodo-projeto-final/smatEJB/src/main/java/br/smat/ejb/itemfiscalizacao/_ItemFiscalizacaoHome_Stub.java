...
public class _ItemFiscalizacaoHome_Stub extends Stub implements ItemFiscalizacaoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.itemfiscalizacao.ItemFiscalizacaoHome:0000000000000000", 
    ...
    public ItemFiscalizacao findByPrimaryKey(ItemFiscalizacaoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (ItemFiscalizacao) in.read_Object(ItemFiscalizacao.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.itemfiscalizacao.ItemFiscalizacaoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                ItemFiscalizacaoKey arg0Copy = (ItemFiscalizacaoKey) Util.copyObject(arg0,_orb());
                ItemFiscalizacao result = ((br.smat.ejb.itemfiscalizacao.ItemFiscalizacaoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (ItemFiscalizacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public ItemFiscalizacao create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.itemfiscalizacao.ItemFiscalizacaoHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                ItemFiscalizacao result = ((br.smat.ejb.itemfiscalizacao.ItemFiscalizacaoHome)so.servant).create(arg0);
                return (ItemFiscalizacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllItemFiscalizacao() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllItemFiscalizacao", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllItemFiscalizacao();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllItemFiscalizacao",br.smat.ejb.itemfiscalizacao.ItemFiscalizacaoHome.class);
            if (so == null) {
                return findAllItemFiscalizacao();
            }
            try {
                Collection result = ((br.smat.ejb.itemfiscalizacao.ItemFiscalizacaoHome)so.servant).findAllItemFiscalizacao();
