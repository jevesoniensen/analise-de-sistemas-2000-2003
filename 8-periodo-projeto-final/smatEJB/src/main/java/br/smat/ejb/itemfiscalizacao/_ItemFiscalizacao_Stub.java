...
public class _ItemFiscalizacao_Stub extends Stub implements ItemFiscalizacao {
    ...
    public void setNome(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_nome",br.smat.ejb.itemfiscalizacao.ItemFiscalizacao.class);
            if (so == null) {
                setNome(arg0);
                return;
            }
            try {
                ((br.smat.ejb.itemfiscalizacao.ItemFiscalizacao)so.servant).setNome(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public String getNome() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_nome",br.smat.ejb.itemfiscalizacao.ItemFiscalizacao.class);
            if (so == null) {
                return getNome();
            }
            try {
                return ((br.smat.ejb.itemfiscalizacao.ItemFiscalizacao)so.servant).getNome();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getItemFiscalizacao() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_itemFiscalizacao_", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_itemFiscalizacao_",br.smat.ejb.itemfiscalizacao.ItemFiscalizacao.class);
            if (so == null) {
                return getItemFiscalizacao();
            }
            try {
                return ((br.smat.ejb.itemfiscalizacao.ItemFiscalizacao)so.servant).getItemFiscalizacao();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
