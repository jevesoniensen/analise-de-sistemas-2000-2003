...
/**
 * EJSRemoteBMPLocalAtendimentoHome_60d99d9d
 * @generated
 */
public class EJSRemoteBMPLocalAtendimentoHome_60d99d9d
	extends EJSWrapper
	implements br.smat.ejb.localatendimento.LocalAtendimentoHome {
	/**
	 * EJSRemoteBMPLocalAtendimentoHome_60d99d9d
	 * @generated
	 */
	public EJSRemoteBMPLocalAtendimentoHome_60d99d9d()
	...
	public br.smat.ejb.localatendimento.LocalAtendimento create(
		...
		br.smat.ejb.localatendimento.LocalAtendimento _EJS_result = null;
		try {
			br
				.smat
				.ejb
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, municipio);
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllLocaisAtendimento();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
