...
public class _EJSRemoteBMPLocalAtendimentoHome_60d99d9d_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPLocalAtendimentoHome_60d99d9d target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPLocalAtendimentoHome_60d99d9d) target;
    }
        ...
        try {
            ...
            switch (method.charAt(0)) {
                ...
                case 102: 
                    ...
                    } else if (method.equals("findAllLocaisAtendimento")) {
                        return findAllLocaisAtendimento(in, reply);
                    }
                case 114: 
    ...
    private org.omg.CORBA.portable.OutputStream findAllLocaisAtendimento(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Collection result;
        try {
            result = target.findAllLocaisAtendimento();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
