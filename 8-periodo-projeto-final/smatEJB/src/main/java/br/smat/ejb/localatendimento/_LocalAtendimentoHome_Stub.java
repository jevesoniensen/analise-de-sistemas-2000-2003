...
public class _LocalAtendimentoHome_Stub extends Stub implements LocalAtendimentoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.localatendimento.LocalAtendimentoHome:0000000000000000", 
    ...
    public LocalAtendimento create(String arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LocalAtendimento) in.read_Object(LocalAtendimento.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.localatendimento.LocalAtendimentoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                LocalAtendimento result = ((br.smat.ejb.localatendimento.LocalAtendimentoHome)so.servant).create(arg0, arg1);
                return (LocalAtendimento)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LocalAtendimento findByPrimaryKey(LocalAtendimentoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.localatendimento.LocalAtendimentoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LocalAtendimentoKey arg0Copy = (LocalAtendimentoKey) Util.copyObject(arg0,_orb());
                LocalAtendimento result = ((br.smat.ejb.localatendimento.LocalAtendimentoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LocalAtendimento)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllLocaisAtendimento() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllLocaisAtendimento", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllLocaisAtendimento();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllLocaisAtendimento",br.smat.ejb.localatendimento.LocalAtendimentoHome.class);
            if (so == null) {
                return findAllLocaisAtendimento();
            }
            try {
                Collection result = ((br.smat.ejb.localatendimento.LocalAtendimentoHome)so.servant).findAllLocaisAtendimento();
