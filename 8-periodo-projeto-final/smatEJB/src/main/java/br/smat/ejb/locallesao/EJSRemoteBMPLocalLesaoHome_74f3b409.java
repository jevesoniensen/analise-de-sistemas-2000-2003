...
/**
 * EJSRemoteBMPLocalLesaoHome_74f3b409
 * @generated
 */
public class EJSRemoteBMPLocalLesaoHome_74f3b409
	extends EJSWrapper
	implements br.smat.ejb.locallesao.LocalLesaoHome {
	/**
	 * EJSRemoteBMPLocalLesaoHome_74f3b409
	 * @generated
	 */
	public EJSRemoteBMPLocalLesaoHome_74f3b409()
	...
	public br.smat.ejb.locallesao.LocalLesao create(
		...
		br.smat.ejb.locallesao.LocalLesao _EJS_result = null;
		try {
			br
				.smat
				.ejb
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, localLesaoPai);
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllLocaisLesao();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
		...
		try {
			br
				...
				(
					...
					3,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllLocaisLesao(pai);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
