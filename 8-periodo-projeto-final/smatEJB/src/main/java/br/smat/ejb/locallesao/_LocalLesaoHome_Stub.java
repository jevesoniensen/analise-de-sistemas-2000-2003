...
public class _LocalLesaoHome_Stub extends Stub implements LocalLesaoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.locallesao.LocalLesaoHome:0000000000000000", 
    ...
    public LocalLesao create(String arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LocalLesao) in.read_Object(LocalLesao.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.locallesao.LocalLesaoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                LocalLesao result = ((br.smat.ejb.locallesao.LocalLesaoHome)so.servant).create(arg0, arg1);
                return (LocalLesao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LocalLesao findByPrimaryKey(LocalLesaoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.locallesao.LocalLesaoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LocalLesaoKey arg0Copy = (LocalLesaoKey) Util.copyObject(arg0,_orb());
                LocalLesao result = ((br.smat.ejb.locallesao.LocalLesaoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LocalLesao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllLocaisLesao() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllLocaisLesao__", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllLocaisLesao__",br.smat.ejb.locallesao.LocalLesaoHome.class);
            if (so == null) {
                return findAllLocaisLesao();
            }
            try {
                Collection result = ((br.smat.ejb.locallesao.LocalLesaoHome)so.servant).findAllLocaisLesao();
    ...
    public Collection findAllLocaisLesao(int arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllLocaisLesao__long", true);
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Collection) in.read_value(Collection.class);
                } catch (ApplicationException ex) {
                    ...
                    return findAllLocaisLesao(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllLocaisLesao__long",br.smat.ejb.locallesao.LocalLesaoHome.class);
            if (so == null) {
                return findAllLocaisLesao(arg0);
            }
            try {
                Collection result = ((br.smat.ejb.locallesao.LocalLesaoHome)so.servant).findAllLocaisLesao(arg0);
                return (Collection)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
