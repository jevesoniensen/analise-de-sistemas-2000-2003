...
public class _EJSRemoteBMPLocalLesaoAcidente_de278cc7_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPLocalLesaoAcidente_de278cc7 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPLocalLesaoAcidente_de278cc7) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 108: 
                    if (method.equals("_get_localLesao")) {
                        return _get_localLesao(in, reply);
                    }
                case 110: 
    ...
    private org.omg.CORBA.portable.OutputStream _get_localLesao(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        LocalLesaoKey result = target.getLocalLesao();
        org.omg.CORBA_2_3.portable.OutputStream out = 
            (org.omg.CORBA_2_3.portable.OutputStream) reply.createReply();
