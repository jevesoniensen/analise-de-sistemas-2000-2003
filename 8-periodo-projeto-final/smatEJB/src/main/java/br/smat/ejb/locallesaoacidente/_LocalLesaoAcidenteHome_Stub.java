...
public class _LocalLesaoAcidenteHome_Stub extends Stub implements LocalLesaoAcidenteHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.locallesaoacidente.LocalLesaoAcidenteHome:0000000000000000", 
    ...
    public LocalLesaoAcidente create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LocalLesaoAcidente) in.read_Object(LocalLesaoAcidente.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.locallesaoacidente.LocalLesaoAcidenteHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                LocalLesaoAcidente result = ((br.smat.ejb.locallesaoacidente.LocalLesaoAcidenteHome)so.servant).create(arg0, arg1);
                return (LocalLesaoAcidente)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public LocalLesaoAcidente findByPrimaryKey(LocalLesaoAcidenteKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,LocalLesaoAcidenteKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (LocalLesaoAcidente) in.read_Object(LocalLesaoAcidente.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.locallesaoacidente.LocalLesaoAcidenteHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                LocalLesaoAcidenteKey arg0Copy = (LocalLesaoAcidenteKey) Util.copyObject(arg0,_orb());
                LocalLesaoAcidente result = ((br.smat.ejb.locallesaoacidente.LocalLesaoAcidenteHome)so.servant).findByPrimaryKey(arg0Copy);
                return (LocalLesaoAcidente)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
