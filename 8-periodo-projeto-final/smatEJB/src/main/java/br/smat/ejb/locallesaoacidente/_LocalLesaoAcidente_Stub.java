...
public class _LocalLesaoAcidente_Stub extends Stub implements LocalLesaoAcidente {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.locallesaoacidente.LocalLesaoAcidente:0000000000000000", 
    ...
    public AcidenteKey getAcidente() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_acidente",br.smat.ejb.locallesaoacidente.LocalLesaoAcidente.class);
            if (so == null) {
                return getAcidente();
            }
            try {
                AcidenteKey result = ((br.smat.ejb.locallesaoacidente.LocalLesaoAcidente)so.servant).getAcidente();
    ...
    public LocalLesaoKey getLocalLesao() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_localLesao", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("_get_localLesao",br.smat.ejb.locallesaoacidente.LocalLesaoAcidente.class);
            if (so == null) {
                return getLocalLesao();
            }
            try {
                LocalLesaoKey result = ((br.smat.ejb.locallesaoacidente.LocalLesaoAcidente)so.servant).getLocalLesao();
