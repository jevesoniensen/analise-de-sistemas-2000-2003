...
/**
 * EJSRemoteBMPMedicoHome_39c8201f
 * @generated
 */
public class EJSRemoteBMPMedicoHome_39c8201f
	extends EJSWrapper
	implements br.smat.ejb.medico.MedicoHome {
	/**
	 * EJSRemoteBMPMedicoHome_39c8201f
	 * @generated
	 */
	public EJSRemoteBMPMedicoHome_39c8201f() throws java.rmi.RemoteException {
		super();
	}
	/**
	 * create
	...
	public br.smat.ejb.medico.Medico create(
		...
		br.smat.ejb.medico.Medico _EJS_result = null;
		try {
			br.smat.ejb.medico.EJSBMPMedicoHomeBean_39c8201f _EJS_beanRef =
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, crm, ufCRM);
		...
		try {
			br.smat.ejb.medico.EJSBMPMedicoHomeBean_39c8201f _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllMedicos();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
