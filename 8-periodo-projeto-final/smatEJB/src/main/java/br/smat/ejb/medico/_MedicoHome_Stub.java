...
public class _MedicoHome_Stub extends Stub implements MedicoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.medico.MedicoHome:0000000000000000", 
    ...
    public Medico create(String arg0, int arg1, int arg2) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg2);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Medico) in.read_Object(Medico.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.medico.MedicoHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2);
            }
            try {
                Medico result = ((br.smat.ejb.medico.MedicoHome)so.servant).create(arg0, arg1, arg2);
                return (Medico)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Medico findByPrimaryKey(MedicoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.medico.MedicoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                MedicoKey arg0Copy = (MedicoKey) Util.copyObject(arg0,_orb());
                Medico result = ((br.smat.ejb.medico.MedicoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Medico)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllMedicos() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllMedicos", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllMedicos",br.smat.ejb.medico.MedicoHome.class);
            if (so == null) {
                return findAllMedicos();
            }
            try {
                Collection result = ((br.smat.ejb.medico.MedicoHome)so.servant).findAllMedicos();
