...
/**
 * EJSRemoteBMPMedidaCorretivaFiscalizacaoHome_7dc0c8a6
 * @generated
 */
public class EJSRemoteBMPMedidaCorretivaFiscalizacaoHome_7dc0c8a6
	extends EJSWrapper
	implements br.smat.ejb.medidacorretivafiscalizacao.MedidaCorretivaFiscalizacaoHome {
	/**
	 * EJSRemoteBMPMedidaCorretivaFiscalizacaoHome_7dc0c8a6
	 * @generated
	 */
	public EJSRemoteBMPMedidaCorretivaFiscalizacaoHome_7dc0c8a6()
	...
	public br
		...
		br
			...
			.ejb
			.medidacorretivafiscalizacao
			.MedidaCorretivaFiscalizacao _EJS_result =
			null;
		try {
			br
				.smat
		...
		try {
			br
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.findAllMedidaCorretivaFiscalizacao(
					tramiteFiscalizacao,
					fiscalizacao);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
