...
public class _EJSRemoteBMPMedidaCorretivaFiscalizacaoHome_7dc0c8a6_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPMedidaCorretivaFiscalizacaoHome_7dc0c8a6 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPMedidaCorretivaFiscalizacaoHome_7dc0c8a6) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 34: 
                    if (method.equals("findAllMedidaCorretivaFiscalizacao")) {
                        return findAllMedidaCorretivaFiscalizacao(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        MedidaCorretivaFiscalizacaoKey arg0 = (MedidaCorretivaFiscalizacaoKey) in.read_value(MedidaCorretivaFiscalizacaoKey.class);
    ...
    private org.omg.CORBA.portable.OutputStream findAllMedidaCorretivaFiscalizacao(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        Collection result;
        try {
            result = target.findAllMedidaCorretivaFiscalizacao(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
