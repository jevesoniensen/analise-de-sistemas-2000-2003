...
/**
 * EJSRemoteBMPMedidaCorretivaInvestigacaoHome_fece7eb8
 * @generated
 */
public class EJSRemoteBMPMedidaCorretivaInvestigacaoHome_fece7eb8
	extends EJSWrapper
	implements br.smat.ejb.medidacorretivainvestigacao.MedidaCorretivaInvestigacaoHome {
	/**
	 * EJSRemoteBMPMedidaCorretivaInvestigacaoHome_fece7eb8
	 * @generated
	 */
	public EJSRemoteBMPMedidaCorretivaInvestigacaoHome_fece7eb8()
	...
	public br
		...
		br
			...
			.ejb
			.medidacorretivainvestigacao
			.MedidaCorretivaInvestigacao _EJS_result =
			null;
		try {
			br
				.smat
	...
	public br
		...
		.ejb
		.medidacorretivainvestigacao
		.MedidaCorretivaInvestigacao findByPrimaryKey(
			br
				.smat
				.ejb
				.medidacorretivainvestigacao
		...
		try {
			br
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.findAllMedidaCorretivaInvestigacao(investigacao);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
