...
public class _EJSRemoteBMPMedidaCorretivaInvestigacaoHome_fece7eb8_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPMedidaCorretivaInvestigacaoHome_fece7eb8 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPMedidaCorretivaInvestigacaoHome_fece7eb8) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 34: 
                    if (method.equals("findAllMedidaCorretivaInvestigacao")) {
                        return findAllMedidaCorretivaInvestigacao(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        MedidaCorretivaInvestigacaoKey arg0 = (MedidaCorretivaInvestigacaoKey) in.read_value(MedidaCorretivaInvestigacaoKey.class);
    ...
    private org.omg.CORBA.portable.OutputStream findAllMedidaCorretivaInvestigacao(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Collection result;
        try {
            result = target.findAllMedidaCorretivaInvestigacao(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
