...
/**
 * EJSRemoteBMPMonitorHome_4daaff17
 * @generated
 */
public class EJSRemoteBMPMonitorHome_4daaff17
	extends EJSWrapper
	implements br.smat.ejb.monitor.MonitorHome {
	/**
	 * EJSRemoteBMPMonitorHome_4daaff17
	 * @generated
	 */
	public EJSRemoteBMPMonitorHome_4daaff17() throws java.rmi.RemoteException {
		super();
	}
	/**
	 * create
	...
	public br.smat.ejb.monitor.Monitor create(
		...
		br.smat.ejb.monitor.Monitor _EJS_result = null;
		try {
			br.smat.ejb.monitor.EJSBMPMonitorHomeBean_4daaff17 _EJS_beanRef =
				(
					br
						.smat
						.ejb
						.monitor
						.EJSBMPMonitorHomeBean_4daaff17) container
						.preInvoke(
					this,
					0,
					_EJS_s);
		...
		try {
			br.smat.ejb.monitor.EJSBMPMonitorHomeBean_4daaff17 _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllMonitores();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
