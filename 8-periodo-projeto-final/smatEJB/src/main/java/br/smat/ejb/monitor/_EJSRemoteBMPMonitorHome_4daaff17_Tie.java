...
public class _EJSRemoteBMPMonitorHome_4daaff17_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPMonitorHome_4daaff17 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPMonitorHome_4daaff17) target;
    }
        ...
        try {
            ...
            switch (method.charAt(0)) {
                ...
                case 102: 
                    ...
                    } else if (method.equals("findAllMonitores")) {
                        return findAllMonitores(in, reply);
                    }
                case 114: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        MonitorKey arg0 = (MonitorKey) in.read_value(MonitorKey.class);
        Monitor result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findAllMonitores(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Collection result;
        try {
            result = target.findAllMonitores();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
