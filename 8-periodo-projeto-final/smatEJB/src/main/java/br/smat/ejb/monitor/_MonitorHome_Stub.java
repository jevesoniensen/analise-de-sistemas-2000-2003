...
public class _MonitorHome_Stub extends Stub implements MonitorHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.monitor.MonitorHome:0000000000000000", 
    ...
    public Monitor findByPrimaryKey(MonitorKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,MonitorKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Monitor) in.read_Object(Monitor.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.monitor.MonitorHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                MonitorKey arg0Copy = (MonitorKey) Util.copyObject(arg0,_orb());
                Monitor result = ((br.smat.ejb.monitor.MonitorHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Monitor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllMonitores() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllMonitores", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllMonitores",br.smat.ejb.monitor.MonitorHome.class);
            if (so == null) {
                return findAllMonitores();
            }
            try {
                Collection result = ((br.smat.ejb.monitor.MonitorHome)so.servant).findAllMonitores();
    ...
    public Monitor create(int arg0, int arg1, int arg2, int arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.monitor.MonitorHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                Monitor result = ((br.smat.ejb.monitor.MonitorHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (Monitor)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
