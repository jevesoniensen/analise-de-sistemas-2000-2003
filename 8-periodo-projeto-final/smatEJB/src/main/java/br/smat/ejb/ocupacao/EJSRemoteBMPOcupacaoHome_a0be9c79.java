...
/**
 * EJSRemoteBMPOcupacaoHome_a0be9c79
 * @generated
 */
public class EJSRemoteBMPOcupacaoHome_a0be9c79
	extends EJSWrapper
	implements br.smat.ejb.ocupacao.OcupacaoHome {
	/**
	 * EJSRemoteBMPOcupacaoHome_a0be9c79
	 * @generated
	 */
	public EJSRemoteBMPOcupacaoHome_a0be9c79()
	...
	public br.smat.ejb.ocupacao.Ocupacao create(java.lang.String nome, int cbo)
		...
		br.smat.ejb.ocupacao.Ocupacao _EJS_result = null;
		try {
			br.smat.ejb.ocupacao.EJSBMPOcupacaoHomeBean_a0be9c79 _EJS_beanRef =
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, cbo);
		...
		try {
			br.smat.ejb.ocupacao.EJSBMPOcupacaoHomeBean_a0be9c79 _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllOcupacoes();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
