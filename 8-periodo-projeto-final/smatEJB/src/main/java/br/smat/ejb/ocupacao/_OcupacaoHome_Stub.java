...
public class _OcupacaoHome_Stub extends Stub implements OcupacaoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.ocupacao.OcupacaoHome:0000000000000000", 
    ...
    public Ocupacao create(String arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Ocupacao) in.read_Object(Ocupacao.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.ocupacao.OcupacaoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                Ocupacao result = ((br.smat.ejb.ocupacao.OcupacaoHome)so.servant).create(arg0, arg1);
                return (Ocupacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Ocupacao findByPrimaryKey(OcupacaoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.ocupacao.OcupacaoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                OcupacaoKey arg0Copy = (OcupacaoKey) Util.copyObject(arg0,_orb());
                Ocupacao result = ((br.smat.ejb.ocupacao.OcupacaoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Ocupacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllOcupacoes() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllOcupacoes", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllOcupacoes",br.smat.ejb.ocupacao.OcupacaoHome.class);
            if (so == null) {
                return findAllOcupacoes();
            }
            try {
                Collection result = ((br.smat.ejb.ocupacao.OcupacaoHome)so.servant).findAllOcupacoes();
