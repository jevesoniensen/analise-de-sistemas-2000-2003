...
public class _Ocupacao_Stub extends Stub implements Ocupacao {
    ...
    public void setNome(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_nome",br.smat.ejb.ocupacao.Ocupacao.class);
            if (so == null) {
                setNome(arg0);
                return;
            }
            try {
                ((br.smat.ejb.ocupacao.Ocupacao)so.servant).setNome(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public void setCbo(int arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_set_cbo", true);
                    out.write_long(arg0);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
            ...
            ServantObject so = _servant_preinvoke("_set_cbo",br.smat.ejb.ocupacao.Ocupacao.class);
            if (so == null) {
                setCbo(arg0);
                return;
            }
            try {
                ((br.smat.ejb.ocupacao.Ocupacao)so.servant).setCbo(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
    ...
    public int getOcupacao() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_ocupacao_", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_ocupacao_",br.smat.ejb.ocupacao.Ocupacao.class);
            if (so == null) {
                return getOcupacao();
            }
            try {
                return ((br.smat.ejb.ocupacao.Ocupacao)so.servant).getOcupacao();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public String getNome() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_nome",br.smat.ejb.ocupacao.Ocupacao.class);
            if (so == null) {
                return getNome();
            }
            try {
                return ((br.smat.ejb.ocupacao.Ocupacao)so.servant).getNome();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getCbo() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_cbo", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_cbo",br.smat.ejb.ocupacao.Ocupacao.class);
            if (so == null) {
                return getCbo();
            }
            try {
                return ((br.smat.ejb.ocupacao.Ocupacao)so.servant).getCbo();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
