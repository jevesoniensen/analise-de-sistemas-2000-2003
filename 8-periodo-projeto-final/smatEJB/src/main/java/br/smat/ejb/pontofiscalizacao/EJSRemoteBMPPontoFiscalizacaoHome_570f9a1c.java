...
/**
 * EJSRemoteBMPPontoFiscalizacaoHome_570f9a1c
 * @generated
 */
public class EJSRemoteBMPPontoFiscalizacaoHome_570f9a1c
	extends EJSWrapper
	implements br.smat.ejb.pontofiscalizacao.PontoFiscalizacaoHome {
	/**
	 * EJSRemoteBMPPontoFiscalizacaoHome_570f9a1c
	 * @generated
	 */
	public EJSRemoteBMPPontoFiscalizacaoHome_570f9a1c()
	...
	public br.smat.ejb.pontofiscalizacao.PontoFiscalizacao findByPrimaryKey(
		...
		br.smat.ejb.pontofiscalizacao.PontoFiscalizacao _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllPontoFiscalizacao();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
		...
		try {
			br
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, descricao, ramoAtividade);
		...
		try {
			br
				...
				(
					...
					3,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllPontoFiscalizacao(ramoAtividade);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
