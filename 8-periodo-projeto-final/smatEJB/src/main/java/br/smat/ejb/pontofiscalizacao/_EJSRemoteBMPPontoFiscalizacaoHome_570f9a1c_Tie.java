...
public class _EJSRemoteBMPPontoFiscalizacaoHome_570f9a1c_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPPontoFiscalizacaoHome_570f9a1c target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPPontoFiscalizacaoHome_570f9a1c) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 26: 
                    if (method.equals("findAllPontoFiscalizacao__")) {
                        return findAllPontoFiscalizacao__(in, reply);
                    }
                case 30: 
                    if (method.equals("findAllPontoFiscalizacao__long")) {
                        return findAllPontoFiscalizacao__long(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findAllPontoFiscalizacao__(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Collection result;
        try {
            result = target.findAllPontoFiscalizacao();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findAllPontoFiscalizacao__long(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Collection result;
        try {
            result = target.findAllPontoFiscalizacao(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
