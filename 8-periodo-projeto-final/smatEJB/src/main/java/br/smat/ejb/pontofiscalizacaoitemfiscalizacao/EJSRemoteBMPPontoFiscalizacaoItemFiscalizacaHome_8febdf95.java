...
/**
 * EJSRemoteBMPPontoFiscalizacaoItemFiscalizacaHome_8febdf95
 * @generated
 */
public class EJSRemoteBMPPontoFiscalizacaoItemFiscalizacaHome_8febdf95
	extends EJSWrapper
	implements
		br
		.smat
		...
		.PontoFiscalizacaoItemFiscalizacaoHome {
	/**
	 * EJSRemoteBMPPontoFiscalizacaoItemFiscalizacaHome_8febdf95
	 * @generated
	 */
	public EJSRemoteBMPPontoFiscalizacaoItemFiscalizacaHome_8febdf95()
	...
	public br
		...
		br
			...
			.ejb
			.pontofiscalizacaoitemfiscalizacao
			.PontoFiscalizacaoItemFiscalizacao _EJS_result =
			null;
		try {
			br
				.smat
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.create(pontoFiscalizacao, itemFiscalizacao);
