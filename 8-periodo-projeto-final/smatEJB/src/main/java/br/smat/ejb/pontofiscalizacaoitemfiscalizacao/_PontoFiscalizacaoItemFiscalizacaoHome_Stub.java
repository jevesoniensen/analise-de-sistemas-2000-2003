...
public class _PontoFiscalizacaoItemFiscalizacaoHome_Stub extends Stub implements PontoFiscalizacaoItemFiscalizacaoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.pontofiscalizacaoitemfiscalizacao.PontoFiscalizacaoItemFiscalizacaoHome:0000000000000000", 
    ...
    public PontoFiscalizacaoItemFiscalizacao findByPrimaryKey(PontoFiscalizacaoItemFiscalizacaoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PontoFiscalizacaoItemFiscalizacaoKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PontoFiscalizacaoItemFiscalizacao) in.read_Object(PontoFiscalizacaoItemFiscalizacao.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.pontofiscalizacaoitemfiscalizacao.PontoFiscalizacaoItemFiscalizacaoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PontoFiscalizacaoItemFiscalizacaoKey arg0Copy = (PontoFiscalizacaoItemFiscalizacaoKey) Util.copyObject(arg0,_orb());
                PontoFiscalizacaoItemFiscalizacao result = ((br.smat.ejb.pontofiscalizacaoitemfiscalizacao.PontoFiscalizacaoItemFiscalizacaoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PontoFiscalizacaoItemFiscalizacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PontoFiscalizacaoItemFiscalizacao create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.pontofiscalizacaoitemfiscalizacao.PontoFiscalizacaoItemFiscalizacaoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                PontoFiscalizacaoItemFiscalizacao result = ((br.smat.ejb.pontofiscalizacaoitemfiscalizacao.PontoFiscalizacaoItemFiscalizacaoHome)so.servant).create(arg0, arg1);
                return (PontoFiscalizacaoItemFiscalizacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
