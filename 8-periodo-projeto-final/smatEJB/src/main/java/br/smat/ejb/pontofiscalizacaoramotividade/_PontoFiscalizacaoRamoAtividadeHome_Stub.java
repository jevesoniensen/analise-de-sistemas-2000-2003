...
public class _PontoFiscalizacaoRamoAtividadeHome_Stub extends Stub implements PontoFiscalizacaoRamoAtividadeHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.pontofiscalizacaoramotividade.PontoFiscalizacaoRamoAtividadeHome:0000000000000000", 
    ...
    public PontoFiscalizacaoRamoAtividade create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PontoFiscalizacaoRamoAtividade) in.read_Object(PontoFiscalizacaoRamoAtividade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.pontofiscalizacaoramotividade.PontoFiscalizacaoRamoAtividadeHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                PontoFiscalizacaoRamoAtividade result = ((br.smat.ejb.pontofiscalizacaoramotividade.PontoFiscalizacaoRamoAtividadeHome)so.servant).create(arg0, arg1);
                return (PontoFiscalizacaoRamoAtividade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public PontoFiscalizacaoRamoAtividade findByPrimaryKey(PontoFiscalizacaoRamoAtividadeKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,PontoFiscalizacaoRamoAtividadeKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (PontoFiscalizacaoRamoAtividade) in.read_Object(PontoFiscalizacaoRamoAtividade.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.pontofiscalizacaoramotividade.PontoFiscalizacaoRamoAtividadeHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                PontoFiscalizacaoRamoAtividadeKey arg0Copy = (PontoFiscalizacaoRamoAtividadeKey) Util.copyObject(arg0,_orb());
                PontoFiscalizacaoRamoAtividade result = ((br.smat.ejb.pontofiscalizacaoramotividade.PontoFiscalizacaoRamoAtividadeHome)so.servant).findByPrimaryKey(arg0Copy);
                return (PontoFiscalizacaoRamoAtividade)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
