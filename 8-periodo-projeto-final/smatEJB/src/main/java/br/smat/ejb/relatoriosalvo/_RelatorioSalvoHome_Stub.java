...
public class _RelatorioSalvoHome_Stub extends Stub implements RelatorioSalvoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.relatoriosalvo.RelatorioSalvoHome:0000000000000000", 
    ...
    public RelatorioSalvo create(int arg0, int arg1, String arg2, int arg3, int arg4, String arg5, int arg6, String arg7, String arg8, String arg9, String arg10, String arg11) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RelatorioSalvo) in.read_Object(RelatorioSalvo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.relatoriosalvo.RelatorioSalvoHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
            }
            try {
                RelatorioSalvo result = ((br.smat.ejb.relatoriosalvo.RelatorioSalvoHome)so.servant).create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11);
                return (RelatorioSalvo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public RelatorioSalvo findByPrimaryKey(RelatorioSalvoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,RelatorioSalvoKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (RelatorioSalvo) in.read_Object(RelatorioSalvo.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.relatoriosalvo.RelatorioSalvoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RelatorioSalvoKey arg0Copy = (RelatorioSalvoKey) Util.copyObject(arg0,_orb());
                RelatorioSalvo result = ((br.smat.ejb.relatoriosalvo.RelatorioSalvoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (RelatorioSalvo)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllRelatorios() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllRelatorios", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllRelatorios",br.smat.ejb.relatoriosalvo.RelatorioSalvoHome.class);
            if (so == null) {
                return findAllRelatorios();
            }
            try {
                Collection result = ((br.smat.ejb.relatoriosalvo.RelatorioSalvoHome)so.servant).findAllRelatorios();
