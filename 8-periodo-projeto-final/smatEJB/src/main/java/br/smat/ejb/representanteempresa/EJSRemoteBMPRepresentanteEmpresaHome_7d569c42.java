...
/**
 * EJSRemoteBMPRepresentanteEmpresaHome_7d569c42
 * @generated
 */
public class EJSRemoteBMPRepresentanteEmpresaHome_7d569c42
	extends EJSWrapper
	implements br.smat.ejb.representanteempresa.RepresentanteEmpresaHome {
	/**
	 * EJSRemoteBMPRepresentanteEmpresaHome_7d569c42
	 * @generated
	 */
	public EJSRemoteBMPRepresentanteEmpresaHome_7d569c42()
	...
	public br.smat.ejb.representanteempresa.RepresentanteEmpresa create(
		...
		br.smat.ejb.representanteempresa.RepresentanteEmpresa _EJS_result =
			null;
		try {
			br
				.smat
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(empresa, nome);
		...
		try {
			br
				...
				(
					...
					3,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllRepresentanteEmpresa();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllRepresentanteByEmpresa(empresa);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
