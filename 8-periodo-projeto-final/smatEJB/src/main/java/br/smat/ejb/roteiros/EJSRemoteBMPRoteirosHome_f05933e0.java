...
/**
 * EJSRemoteBMPRoteirosHome_f05933e0
 * @generated
 */
public class EJSRemoteBMPRoteirosHome_f05933e0
	extends EJSWrapper
	implements br.smat.ejb.roteiros.RoteirosHome {
	/**
	 * EJSRemoteBMPRoteirosHome_f05933e0
	 * @generated
	 */
	public EJSRemoteBMPRoteirosHome_f05933e0()
	...
	public br.smat.ejb.roteiros.Roteiros findByPrimaryKey(
		...
		br.smat.ejb.roteiros.Roteiros _EJS_result = null;
		try {
		...
		try {
			br.smat.ejb.roteiros.EJSBMPRoteirosHomeBean_f05933e0 _EJS_beanRef =
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.findAllRoteiros(tramiteFiscalizacao, fiscalizacao);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
		...
		try {
			br.smat.ejb.roteiros.EJSBMPRoteirosHomeBean_f05933e0 _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllItemLastTramite(fiscalizacao);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
