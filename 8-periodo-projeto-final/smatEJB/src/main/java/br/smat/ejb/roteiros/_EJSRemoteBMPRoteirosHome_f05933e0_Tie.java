...
public class _EJSRemoteBMPRoteirosHome_f05933e0_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPRoteirosHome_f05933e0 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPRoteirosHome_f05933e0) target;
    }
        ...
        try {
            ...
            switch (method.length()) {
                ...
                case 15: 
                    ...
                    } else if (method.equals("findAllRoteiros")) {
                        return findAllRoteiros(in, reply);
                    }
                case 16: 
                ...
                case 22: 
                    if (method.equals("findAllItemLastTramite")) {
                        return findAllItemLastTramite(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        RoteirosKey arg0 = (RoteirosKey) in.read_value(RoteirosKey.class);
        Roteiros result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findAllRoteiros(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        int arg1 = in.read_long();
        Collection result;
        try {
            result = target.findAllRoteiros(arg0, arg1);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findAllItemLastTramite(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Collection result;
        try {
            result = target.findAllItemLastTramite(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
