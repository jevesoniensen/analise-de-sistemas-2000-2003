...
public class _RoteirosHome_Stub extends Stub implements RoteirosHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.roteiros.RoteirosHome:0000000000000000", 
    ...
    public Roteiros findByPrimaryKey(RoteirosKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,RoteirosKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Roteiros) in.read_Object(Roteiros.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.roteiros.RoteirosHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                RoteirosKey arg0Copy = (RoteirosKey) Util.copyObject(arg0,_orb());
                Roteiros result = ((br.smat.ejb.roteiros.RoteirosHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Roteiros)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllRoteiros(int arg0, int arg1) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllRoteiros", true);
                    out.write_long(arg0);
                    out.write_long(arg1);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllRoteiros(arg0,arg1);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllRoteiros",br.smat.ejb.roteiros.RoteirosHome.class);
            if (so == null) {
                return findAllRoteiros(arg0, arg1);
            }
            try {
                Collection result = ((br.smat.ejb.roteiros.RoteirosHome)so.servant).findAllRoteiros(arg0, arg1);
    ...
    public Roteiros create(int arg0, int arg1, int arg2, int arg3, String arg4) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.roteiros.RoteirosHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3, arg4);
            }
            try {
                Roteiros result = ((br.smat.ejb.roteiros.RoteirosHome)so.servant).create(arg0, arg1, arg2, arg3, arg4);
                return (Roteiros)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllItemLastTramite(int arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllItemLastTramite", true);
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Collection) in.read_value(Collection.class);
                } catch (ApplicationException ex) {
                    ...
                    return findAllItemLastTramite(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllItemLastTramite",br.smat.ejb.roteiros.RoteirosHome.class);
            if (so == null) {
                return findAllItemLastTramite(arg0);
            }
            try {
                Collection result = ((br.smat.ejb.roteiros.RoteirosHome)so.servant).findAllItemLastTramite(arg0);
                return (Collection)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                if (exCopy instanceof FinderException) {
