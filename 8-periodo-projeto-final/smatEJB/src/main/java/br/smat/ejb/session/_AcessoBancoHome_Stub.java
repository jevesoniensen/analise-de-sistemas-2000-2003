...
public class _AcessoBancoHome_Stub extends Stub implements AcessoBancoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.session.AcessoBancoHome:0000000000000000", 
    ...
    public AcessoBanco create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AcessoBanco) in.read_Object(AcessoBanco.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.session.AcessoBancoHome.class);
            if (so == null) {
                return create();
            }
            try {
                AcessoBanco result = ((br.smat.ejb.session.AcessoBancoHome)so.servant).create();
                return (AcessoBanco)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
