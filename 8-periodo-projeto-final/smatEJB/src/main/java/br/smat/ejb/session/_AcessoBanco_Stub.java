...
public class _AcessoBanco_Stub extends Stub implements AcessoBanco {
    ...
    public void cadastraAcidente() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("cadastraAcidente", true);
                    _invoke(out);
                    return;
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("cadastraAcidente",br.smat.ejb.session.AcessoBanco.class);
            if (so == null) {
                cadastraAcidente();
                return;
            }
            try {
                ((br.smat.ejb.session.AcessoBanco)so.servant).cadastraAcidente();
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
