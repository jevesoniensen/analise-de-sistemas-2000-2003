...
public class _EJSRemoteStatelessAcessoBanco_3eade627_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteStatelessAcessoBanco_3eade627 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.session.AcessoBanco:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteStatelessAcessoBanco_3eade627) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.charAt(5)) {
                ...
                case 116: 
                    if (method.equals("cadastraAcidente")) {
                        return cadastraAcidente(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream cadastraAcidente(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        target.cadastraAcidente();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
        return out;
    }
}
