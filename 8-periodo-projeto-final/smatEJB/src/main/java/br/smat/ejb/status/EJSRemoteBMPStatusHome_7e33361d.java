...
/**
 * EJSRemoteBMPStatusHome_7e33361d
 * @generated
 */
public class EJSRemoteBMPStatusHome_7e33361d
	extends EJSWrapper
	implements br.smat.ejb.status.StatusHome {
	/**
	 * EJSRemoteBMPStatusHome_7e33361d
	 * @generated
	 */
	public EJSRemoteBMPStatusHome_7e33361d() throws java.rmi.RemoteException {
		super();
	}
	/**
	 * create
	...
	public br.smat.ejb.status.Status create(
		...
		br.smat.ejb.status.Status _EJS_result = null;
		try {
		...
		try {
			br.smat.ejb.status.EJSBMPStatusHomeBean_7e33361d _EJS_beanRef =
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllStatus();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
