...
public class _StatusHome_Stub extends Stub implements StatusHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.status.StatusHome:0000000000000000", 
    ...
    public Status findByPrimaryKey(StatusKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Status) in.read_Object(Status.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.status.StatusHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                StatusKey arg0Copy = (StatusKey) Util.copyObject(arg0,_orb());
                Status result = ((br.smat.ejb.status.StatusHome)so.servant).findByPrimaryKey(arg0Copy);
                return (Status)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllStatus() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllStatus", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllStatus",br.smat.ejb.status.StatusHome.class);
            if (so == null) {
                return findAllStatus();
            }
            try {
                Collection result = ((br.smat.ejb.status.StatusHome)so.servant).findAllStatus();
    ...
    public Status create(String arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.status.StatusHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                Status result = ((br.smat.ejb.status.StatusHome)so.servant).create(arg0, arg1);
                return (Status)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
