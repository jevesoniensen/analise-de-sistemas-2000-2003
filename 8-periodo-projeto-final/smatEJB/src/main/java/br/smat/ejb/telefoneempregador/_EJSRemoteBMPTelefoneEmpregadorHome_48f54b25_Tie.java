...
public class _EJSRemoteBMPTelefoneEmpregadorHome_48f54b25_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPTelefoneEmpregadorHome_48f54b25 target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPTelefoneEmpregadorHome_48f54b25) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 28: 
                    if (method.equals("findAllTelefonesEmpregadores")) {
                        return findAllTelefonesEmpregadores(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream findByPrimaryKey(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        TelefoneEmpregadorKey arg0 = (TelefoneEmpregadorKey) in.read_value(TelefoneEmpregadorKey.class);
        TelefoneEmpregador result;
        try {
    ...
    private org.omg.CORBA.portable.OutputStream findAllTelefonesEmpregadores(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Collection result;
        try {
            result = target.findAllTelefonesEmpregadores(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
