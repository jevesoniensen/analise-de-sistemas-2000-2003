...
public class _TelefoneEmpregadorHome_Stub extends Stub implements TelefoneEmpregadorHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.telefoneempregador.TelefoneEmpregadorHome:0000000000000000", 
    ...
    public TelefoneEmpregador create(int arg0, String arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TelefoneEmpregador) in.read_Object(TelefoneEmpregador.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.telefoneempregador.TelefoneEmpregadorHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                TelefoneEmpregador result = ((br.smat.ejb.telefoneempregador.TelefoneEmpregadorHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (TelefoneEmpregador)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public TelefoneEmpregador findByPrimaryKey(TelefoneEmpregadorKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,TelefoneEmpregadorKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TelefoneEmpregador) in.read_Object(TelefoneEmpregador.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.telefoneempregador.TelefoneEmpregadorHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                TelefoneEmpregadorKey arg0Copy = (TelefoneEmpregadorKey) Util.copyObject(arg0,_orb());
                TelefoneEmpregador result = ((br.smat.ejb.telefoneempregador.TelefoneEmpregadorHome)so.servant).findByPrimaryKey(arg0Copy);
                return (TelefoneEmpregador)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTelefonesEmpregadores(int arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTelefonesEmpregadores", true);
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllTelefonesEmpregadores(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllTelefonesEmpregadores",br.smat.ejb.telefoneempregador.TelefoneEmpregadorHome.class);
            if (so == null) {
                return findAllTelefonesEmpregadores(arg0);
            }
            try {
                Collection result = ((br.smat.ejb.telefoneempregador.TelefoneEmpregadorHome)so.servant).findAllTelefonesEmpregadores(arg0);
