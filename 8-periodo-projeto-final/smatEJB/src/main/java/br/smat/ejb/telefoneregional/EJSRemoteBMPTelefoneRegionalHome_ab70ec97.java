...
/**
 * EJSRemoteBMPTelefoneRegionalHome_ab70ec97
 * @generated
 */
public class EJSRemoteBMPTelefoneRegionalHome_ab70ec97
	extends EJSWrapper
	implements br.smat.ejb.telefoneregional.TelefoneRegionalHome {
	/**
	 * EJSRemoteBMPTelefoneRegionalHome_ab70ec97
	 * @generated
	 */
	public EJSRemoteBMPTelefoneRegionalHome_ab70ec97()
	...
	public br.smat.ejb.telefoneregional.TelefoneRegional create(
		...
		br.smat.ejb.telefoneregional.TelefoneRegional _EJS_result = null;
		try {
			br
				.smat
				.ejb
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(regional, descricao, numero, ddd);
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllTelefonesRegionais(regional);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
