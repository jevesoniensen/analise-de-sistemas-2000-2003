...
public class _TelefoneRegionalHome_Stub extends Stub implements TelefoneRegionalHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.telefoneregional.TelefoneRegionalHome:0000000000000000", 
    ...
    public TelefoneRegional create(int arg0, String arg1, String arg2, String arg3) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TelefoneRegional) in.read_Object(TelefoneRegional.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.telefoneregional.TelefoneRegionalHome.class);
            if (so == null) {
                return create(arg0, arg1, arg2, arg3);
            }
            try {
                TelefoneRegional result = ((br.smat.ejb.telefoneregional.TelefoneRegionalHome)so.servant).create(arg0, arg1, arg2, arg3);
                return (TelefoneRegional)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public TelefoneRegional findByPrimaryKey(TelefoneRegionalKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    out.write_value(arg0,TelefoneRegionalKey.class);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TelefoneRegional) in.read_Object(TelefoneRegional.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.telefoneregional.TelefoneRegionalHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                TelefoneRegionalKey arg0Copy = (TelefoneRegionalKey) Util.copyObject(arg0,_orb());
                TelefoneRegional result = ((br.smat.ejb.telefoneregional.TelefoneRegionalHome)so.servant).findByPrimaryKey(arg0Copy);
                return (TelefoneRegional)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTelefonesRegionais(int arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTelefonesRegionais", true);
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllTelefonesRegionais(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllTelefonesRegionais",br.smat.ejb.telefoneregional.TelefoneRegionalHome.class);
            if (so == null) {
                return findAllTelefonesRegionais(arg0);
            }
            try {
                Collection result = ((br.smat.ejb.telefoneregional.TelefoneRegionalHome)so.servant).findAllTelefonesRegionais(arg0);
