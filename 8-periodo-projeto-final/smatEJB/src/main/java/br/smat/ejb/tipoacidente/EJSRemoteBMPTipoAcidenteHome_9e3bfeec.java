...
/**
 * EJSRemoteBMPTipoAcidenteHome_9e3bfeec
 * @generated
 */
public class EJSRemoteBMPTipoAcidenteHome_9e3bfeec
	extends EJSWrapper
	implements br.smat.ejb.tipoacidente.TipoAcidenteHome {
	/**
	 * EJSRemoteBMPTipoAcidenteHome_9e3bfeec
	 * @generated
	 */
	public EJSRemoteBMPTipoAcidenteHome_9e3bfeec()
	...
	public br.smat.ejb.tipoacidente.TipoAcidente create(java.lang.String nome)
		...
		br.smat.ejb.tipoacidente.TipoAcidente _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllTiposAcidente();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
