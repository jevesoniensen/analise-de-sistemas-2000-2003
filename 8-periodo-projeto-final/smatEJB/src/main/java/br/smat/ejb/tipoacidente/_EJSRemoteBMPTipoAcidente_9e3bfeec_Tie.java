...
public class _EJSRemoteBMPTipoAcidente_9e3bfeec_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPTipoAcidente_9e3bfeec target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.tipoacidente.TipoAcidente:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPTipoAcidente_9e3bfeec) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 18: 
                    if (method.equals("_get_tipoAcidente_")) {
                        return _get_tipoAcidente_(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_tipoAcidente_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getTipoAcidente();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
