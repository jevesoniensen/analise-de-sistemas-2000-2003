...
public class _TipoAcidenteHome_Stub extends Stub implements TipoAcidenteHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.tipoacidente.TipoAcidenteHome:0000000000000000", 
    ...
    public TipoAcidente create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TipoAcidente) in.read_Object(TipoAcidente.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.tipoacidente.TipoAcidenteHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                TipoAcidente result = ((br.smat.ejb.tipoacidente.TipoAcidenteHome)so.servant).create(arg0);
                return (TipoAcidente)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public TipoAcidente findByPrimaryKey(TipoAcidenteKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.tipoacidente.TipoAcidenteHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                TipoAcidenteKey arg0Copy = (TipoAcidenteKey) Util.copyObject(arg0,_orb());
                TipoAcidente result = ((br.smat.ejb.tipoacidente.TipoAcidenteHome)so.servant).findByPrimaryKey(arg0Copy);
                return (TipoAcidente)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTiposAcidente() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTiposAcidente", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllTiposAcidente",br.smat.ejb.tipoacidente.TipoAcidenteHome.class);
            if (so == null) {
                return findAllTiposAcidente();
            }
            try {
                Collection result = ((br.smat.ejb.tipoacidente.TipoAcidenteHome)so.servant).findAllTiposAcidente();
