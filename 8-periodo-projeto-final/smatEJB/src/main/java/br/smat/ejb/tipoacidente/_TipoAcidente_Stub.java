...
public class _TipoAcidente_Stub extends Stub implements TipoAcidente {
    ...
    public String getNome() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_nome",br.smat.ejb.tipoacidente.TipoAcidente.class);
            if (so == null) {
                return getNome();
            }
            try {
                return ((br.smat.ejb.tipoacidente.TipoAcidente)so.servant).getNome();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getTipoAcidente() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_tipoAcidente_", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_tipoAcidente_",br.smat.ejb.tipoacidente.TipoAcidente.class);
            if (so == null) {
                return getTipoAcidente();
            }
            try {
                return ((br.smat.ejb.tipoacidente.TipoAcidente)so.servant).getTipoAcidente();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
