...
/**
 * EJSRemoteBMPTipoDepoimentoHome_157640b2
 * @generated
 */
public class EJSRemoteBMPTipoDepoimentoHome_157640b2
	extends EJSWrapper
	implements br.smat.ejb.tipodepoimento.TipoDepoimentoHome {
	/**
	 * EJSRemoteBMPTipoDepoimentoHome_157640b2
	 * @generated
	 */
	public EJSRemoteBMPTipoDepoimentoHome_157640b2()
	...
	public br.smat.ejb.tipodepoimento.TipoDepoimento create(
		...
		br.smat.ejb.tipodepoimento.TipoDepoimento _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllTiposDepoimento();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
