...
public class _EJSRemoteBMPTipoDepoimento_157640b2_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPTipoDepoimento_157640b2 target = null;
    private org.omg.CORBA.ORB orb = null;
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.tipodepoimento.TipoDepoimento:0000000000000000", 
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPTipoDepoimento_157640b2) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 20: 
                    if (method.equals("_get_tipoDepoimento_")) {
                        return _get_tipoDepoimento_(in, reply);
                    }
            }
    ...
    private org.omg.CORBA.portable.OutputStream _get_tipoDepoimento_(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int result = target.getTipoDepoimento();
        org.omg.CORBA.portable.OutputStream out = reply.createReply();
