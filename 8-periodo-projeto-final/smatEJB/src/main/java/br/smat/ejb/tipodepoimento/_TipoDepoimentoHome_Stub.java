...
public class _TipoDepoimentoHome_Stub extends Stub implements TipoDepoimentoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.tipodepoimento.TipoDepoimentoHome:0000000000000000", 
    ...
    public TipoDepoimento create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TipoDepoimento) in.read_Object(TipoDepoimento.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.tipodepoimento.TipoDepoimentoHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                TipoDepoimento result = ((br.smat.ejb.tipodepoimento.TipoDepoimentoHome)so.servant).create(arg0);
                return (TipoDepoimento)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public TipoDepoimento findByPrimaryKey(TipoDepoimentoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.tipodepoimento.TipoDepoimentoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                TipoDepoimentoKey arg0Copy = (TipoDepoimentoKey) Util.copyObject(arg0,_orb());
                TipoDepoimento result = ((br.smat.ejb.tipodepoimento.TipoDepoimentoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (TipoDepoimento)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTiposDepoimento() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTiposDepoimento", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
            ...
            ServantObject so = _servant_preinvoke("findAllTiposDepoimento",br.smat.ejb.tipodepoimento.TipoDepoimentoHome.class);
            if (so == null) {
                return findAllTiposDepoimento();
            }
            try {
                Collection result = ((br.smat.ejb.tipodepoimento.TipoDepoimentoHome)so.servant).findAllTiposDepoimento();
