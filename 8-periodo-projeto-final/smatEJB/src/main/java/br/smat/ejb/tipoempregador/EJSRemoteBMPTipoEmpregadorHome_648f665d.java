...
/**
 * EJSRemoteBMPTipoEmpregadorHome_648f665d
 * @generated
 */
public class EJSRemoteBMPTipoEmpregadorHome_648f665d
	extends EJSWrapper
	implements br.smat.ejb.tipoempregador.TipoEmpregadorHome {
	/**
	 * EJSRemoteBMPTipoEmpregadorHome_648f665d
	 * @generated
	 */
	public EJSRemoteBMPTipoEmpregadorHome_648f665d()
	...
	public br.smat.ejb.tipoempregador.TipoEmpregador create(
		...
		br.smat.ejb.tipoempregador.TipoEmpregador _EJS_result = null;
		try {
			br
				.smat
				.ejb
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, docIdentificador);
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllTiposEmpregadores();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
