...
public class _TipoEmpregadorHome_Stub extends Stub implements TipoEmpregadorHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.tipoempregador.TipoEmpregadorHome:0000000000000000", 
    ...
    public TipoEmpregador create(String arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TipoEmpregador) in.read_Object(TipoEmpregador.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.tipoempregador.TipoEmpregadorHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                TipoEmpregador result = ((br.smat.ejb.tipoempregador.TipoEmpregadorHome)so.servant).create(arg0, arg1);
                return (TipoEmpregador)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public TipoEmpregador findByPrimaryKey(TipoEmpregadorKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.tipoempregador.TipoEmpregadorHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                TipoEmpregadorKey arg0Copy = (TipoEmpregadorKey) Util.copyObject(arg0,_orb());
                TipoEmpregador result = ((br.smat.ejb.tipoempregador.TipoEmpregadorHome)so.servant).findByPrimaryKey(arg0Copy);
                return (TipoEmpregador)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTiposEmpregadores() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTiposEmpregadores", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllTiposEmpregadores();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllTiposEmpregadores",br.smat.ejb.tipoempregador.TipoEmpregadorHome.class);
            if (so == null) {
                return findAllTiposEmpregadores();
            }
            try {
                Collection result = ((br.smat.ejb.tipoempregador.TipoEmpregadorHome)so.servant).findAllTiposEmpregadores();
