...
/**
 * EJSRemoteBMPTipoLocalAcidenteHome_901fdf7f
 * @generated
 */
public class EJSRemoteBMPTipoLocalAcidenteHome_901fdf7f
	extends EJSWrapper
	implements br.smat.ejb.tipolocalacidente.TipoLocalAcidenteHome {
	/**
	 * EJSRemoteBMPTipoLocalAcidenteHome_901fdf7f
	 * @generated
	 */
	public EJSRemoteBMPTipoLocalAcidenteHome_901fdf7f()
	...
	public br.smat.ejb.tipolocalacidente.TipoLocalAcidente create(
		...
		br.smat.ejb.tipolocalacidente.TipoLocalAcidente _EJS_result = null;
		try {
			br
				.smat
				.ejb
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllTiposLocalAcidente();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
