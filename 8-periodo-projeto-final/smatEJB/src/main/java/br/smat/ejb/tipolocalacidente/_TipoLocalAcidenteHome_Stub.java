...
public class _TipoLocalAcidenteHome_Stub extends Stub implements TipoLocalAcidenteHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.tipolocalacidente.TipoLocalAcidenteHome:0000000000000000", 
    ...
    public TipoLocalAcidente create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TipoLocalAcidente) in.read_Object(TipoLocalAcidente.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.tipolocalacidente.TipoLocalAcidenteHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                TipoLocalAcidente result = ((br.smat.ejb.tipolocalacidente.TipoLocalAcidenteHome)so.servant).create(arg0);
                return (TipoLocalAcidente)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public TipoLocalAcidente findByPrimaryKey(TipoLocalAcidenteKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.tipolocalacidente.TipoLocalAcidenteHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                TipoLocalAcidenteKey arg0Copy = (TipoLocalAcidenteKey) Util.copyObject(arg0,_orb());
                TipoLocalAcidente result = ((br.smat.ejb.tipolocalacidente.TipoLocalAcidenteHome)so.servant).findByPrimaryKey(arg0Copy);
                return (TipoLocalAcidente)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTiposLocalAcidente() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTiposLocalAcidente", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllTiposLocalAcidente();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllTiposLocalAcidente",br.smat.ejb.tipolocalacidente.TipoLocalAcidenteHome.class);
            if (so == null) {
                return findAllTiposLocalAcidente();
            }
            try {
                Collection result = ((br.smat.ejb.tipolocalacidente.TipoLocalAcidenteHome)so.servant).findAllTiposLocalAcidente();
