...
public class _TipoLocalAcidente_Stub extends Stub implements TipoLocalAcidente {
    ...
    public String getNome() throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_get_nome",br.smat.ejb.tipolocalacidente.TipoLocalAcidente.class);
            if (so == null) {
                return getNome();
            }
            try {
                return ((br.smat.ejb.tipolocalacidente.TipoLocalAcidente)so.servant).getNome();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public int getTipoLocalAcidente() throws RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("_get_tipoLocalAcidente_", true);
                    in = _invoke(out);
                    return in.read_long();
                } catch (ApplicationException ex) {
                    in = ex.getInputStream();
            ...
            ServantObject so = _servant_preinvoke("_get_tipoLocalAcidente_",br.smat.ejb.tipolocalacidente.TipoLocalAcidente.class);
            if (so == null) {
                return getTipoLocalAcidente();
            }
            try {
                return ((br.smat.ejb.tipolocalacidente.TipoLocalAcidente)so.servant).getTipoLocalAcidente();
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
            } finally {
    ...
    public void setNome(String arg0) throws RemoteException {
        if (!Util.isLocal(this)) {
            ...
            ServantObject so = _servant_preinvoke("_set_nome",br.smat.ejb.tipolocalacidente.TipoLocalAcidente.class);
            if (so == null) {
                setNome(arg0);
                return;
            }
            try {
                ((br.smat.ejb.tipolocalacidente.TipoLocalAcidente)so.servant).setNome(arg0);
                return;
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
                throw Util.wrapException(exCopy);
