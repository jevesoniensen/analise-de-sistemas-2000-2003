...
/**
 * EJSRemoteBMPTipoMedidaCorretivaHome_77914a2a
 * @generated
 */
public class EJSRemoteBMPTipoMedidaCorretivaHome_77914a2a
	extends EJSWrapper
	implements br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretivaHome {
	/**
	 * EJSRemoteBMPTipoMedidaCorretivaHome_77914a2a
	 * @generated
	 */
	public EJSRemoteBMPTipoMedidaCorretivaHome_77914a2a()
	...
	public br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretiva create(
		...
		br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretiva _EJS_result = null;
		try {
			br
				.smat
				.ejb
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(nome, descricao);
	...
	public br
		...
		.ejb
		.tipomedidacorretiva
		.TipoMedidaCorretiva findByPrimaryKey(
		...
		try {
			br
				...
				(
					...
					2,
					_EJS_s);
			_EJS_result = _EJS_beanRef.findAllTipoMedidaCorretiva();
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
