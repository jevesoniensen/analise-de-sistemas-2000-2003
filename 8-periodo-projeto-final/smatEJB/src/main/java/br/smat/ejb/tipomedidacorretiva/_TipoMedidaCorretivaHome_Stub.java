...
public class _TipoMedidaCorretivaHome_Stub extends Stub implements TipoMedidaCorretivaHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretivaHome:0000000000000000", 
    ...
    public TipoMedidaCorretiva findByPrimaryKey(TipoMedidaCorretivaKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TipoMedidaCorretiva) in.read_Object(TipoMedidaCorretiva.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretivaHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                TipoMedidaCorretivaKey arg0Copy = (TipoMedidaCorretivaKey) Util.copyObject(arg0,_orb());
                TipoMedidaCorretiva result = ((br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretivaHome)so.servant).findByPrimaryKey(arg0Copy);
                return (TipoMedidaCorretiva)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTipoMedidaCorretiva() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTipoMedidaCorretiva", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllTipoMedidaCorretiva();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllTipoMedidaCorretiva",br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretivaHome.class);
            if (so == null) {
                return findAllTipoMedidaCorretiva();
            }
            try {
                Collection result = ((br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretivaHome)so.servant).findAllTipoMedidaCorretiva();
    ...
    public TipoMedidaCorretiva create(String arg0, String arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretivaHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                TipoMedidaCorretiva result = ((br.smat.ejb.tipomedidacorretiva.TipoMedidaCorretivaHome)so.servant).create(arg0, arg1);
                return (TipoMedidaCorretiva)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
