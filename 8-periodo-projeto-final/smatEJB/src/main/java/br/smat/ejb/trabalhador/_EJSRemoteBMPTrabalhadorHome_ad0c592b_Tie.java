...
public class _EJSRemoteBMPTrabalhadorHome_ad0c592b_Tie extends org.omg.CORBA_2_3.portable.ObjectImpl implements javax.rmi.CORBA.Tie {
    
    private EJSRemoteBMPTrabalhadorHome_ad0c592b target = null;
    ...
    public void setTarget(java.rmi.Remote target) {
        this.target = (EJSRemoteBMPTrabalhadorHome_ad0c592b) target;
    }
    ...
    public org.omg.CORBA.portable.OutputStream _invoke(String method, org.omg.CORBA.portable.InputStream _in, org.omg.CORBA.portable.ResponseHandler reply) throws org.omg.CORBA.SystemException {
        try {
            ...
            switch (method.length()) {
                ...
                case 14: 
                    if (method.equals("findByAcidente")) {
                        return findByAcidente(in, reply);
                    }
                case 15: 
                ...
                case 20: 
                    if (method.equals("findAllTrabalhadores")) {
                        return findAllTrabalhadores(in, reply);
                    }
                case 24: 
    ...
    private org.omg.CORBA.portable.OutputStream create(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        ...
        String arg19 = (String) in.read_value(String.class);
        ...
        Trabalhador result;
        try {
            result = target.create(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22);
    ...
    private org.omg.CORBA.portable.OutputStream findAllTrabalhadores(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        Collection result;
        try {
            result = target.findAllTrabalhadores();
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
    ...
    private org.omg.CORBA.portable.OutputStream findByAcidente(org.omg.CORBA_2_3.portable.InputStream in , org.omg.CORBA.portable.ResponseHandler reply) throws Throwable {
        int arg0 = in.read_long();
        Trabalhador result;
        try {
            result = target.findByAcidente(arg0);
        } catch (FinderException ex) {
            String id = "IDL:javax/ejb/FinderEx:1.0";
            org.omg.CORBA_2_3.portable.OutputStream out = 
                (org.omg.CORBA_2_3.portable.OutputStream) reply.createExceptionReply();
