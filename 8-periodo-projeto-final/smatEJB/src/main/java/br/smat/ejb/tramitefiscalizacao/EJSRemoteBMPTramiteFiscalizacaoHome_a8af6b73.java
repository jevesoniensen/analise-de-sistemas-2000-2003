...
/**
 * EJSRemoteBMPTramiteFiscalizacaoHome_a8af6b73
 * @generated
 */
public class EJSRemoteBMPTramiteFiscalizacaoHome_a8af6b73
	extends EJSWrapper
	implements br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacaoHome {
	/**
	 * EJSRemoteBMPTramiteFiscalizacaoHome_a8af6b73
	 * @generated
	 */
	public EJSRemoteBMPTramiteFiscalizacaoHome_a8af6b73()
	...
	public br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacao create(
		...
		br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacao _EJS_result = null;
		try {
			br
				.smat
				.ejb
				...
				(
					...
					0,
					_EJS_s);
			_EJS_result = _EJS_beanRef.create(fiscalizacao, status);
		...
		try {
			br
				...
				(
					...
					_EJS_s);
			_EJS_result =
				_EJS_beanRef.findAllTramitesFiscalizacao(fiscalizacao);
		} catch (javax.ejb.FinderException ex) {
			_EJS_s.setCheckedException(ex);
			throw ex;
		} catch (java.rmi.RemoteException ex) {
