...
public class _TramiteFiscalizacaoHome_Stub extends Stub implements TramiteFiscalizacaoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacaoHome:0000000000000000", 
    ...
    public TramiteFiscalizacao findByPrimaryKey(TramiteFiscalizacaoKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (TramiteFiscalizacao) in.read_Object(TramiteFiscalizacao.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacaoHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                TramiteFiscalizacaoKey arg0Copy = (TramiteFiscalizacaoKey) Util.copyObject(arg0,_orb());
                TramiteFiscalizacao result = ((br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacaoHome)so.servant).findByPrimaryKey(arg0Copy);
                return (TramiteFiscalizacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public TramiteFiscalizacao create(int arg0, int arg1) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacaoHome.class);
            if (so == null) {
                return create(arg0, arg1);
            }
            try {
                TramiteFiscalizacao result = ((br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacaoHome)so.servant).create(arg0, arg1);
                return (TramiteFiscalizacao)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllTramitesFiscalizacao(int arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllTramitesFiscalizacao", true);
                    out.write_long(arg0);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllTramitesFiscalizacao(arg0);
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllTramitesFiscalizacao",br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacaoHome.class);
            if (so == null) {
                return findAllTramitesFiscalizacao(arg0);
            }
            try {
                Collection result = ((br.smat.ejb.tramitefiscalizacao.TramiteFiscalizacaoHome)so.servant).findAllTramitesFiscalizacao(arg0);
