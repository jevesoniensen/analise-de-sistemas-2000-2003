...
public class _VinculoEmpregaticioHome_Stub extends Stub implements VinculoEmpregaticioHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.ejb.vinculoempregaticio.VinculoEmpregaticioHome:0000000000000000", 
    ...
    public VinculoEmpregaticio create(String arg0) throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (VinculoEmpregaticio) in.read_Object(VinculoEmpregaticio.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.ejb.vinculoempregaticio.VinculoEmpregaticioHome.class);
            if (so == null) {
                return create(arg0);
            }
            try {
                VinculoEmpregaticio result = ((br.smat.ejb.vinculoempregaticio.VinculoEmpregaticioHome)so.servant).create(arg0);
                return (VinculoEmpregaticio)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public VinculoEmpregaticio findByPrimaryKey(VinculoEmpregaticioKey arg0) throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
            ...
            ServantObject so = _servant_preinvoke("findByPrimaryKey",br.smat.ejb.vinculoempregaticio.VinculoEmpregaticioHome.class);
            if (so == null) {
                return findByPrimaryKey(arg0);
            }
            try {
                VinculoEmpregaticioKey arg0Copy = (VinculoEmpregaticioKey) Util.copyObject(arg0,_orb());
                VinculoEmpregaticio result = ((br.smat.ejb.vinculoempregaticio.VinculoEmpregaticioHome)so.servant).findByPrimaryKey(arg0Copy);
                return (VinculoEmpregaticio)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
    ...
    public Collection findAllVinculosEmpregaticios() throws FinderException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    org.omg.CORBA.portable.OutputStream out = _request("findAllVinculosEmpregaticios", true);
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    ...
                    return findAllVinculosEmpregaticios();
                } finally {
                    _releaseReply(in);
                }
            } catch (SystemException ex) {
            ...
            ServantObject so = _servant_preinvoke("findAllVinculosEmpregaticios",br.smat.ejb.vinculoempregaticio.VinculoEmpregaticioHome.class);
            if (so == null) {
                return findAllVinculosEmpregaticios();
            }
            try {
                Collection result = ((br.smat.ejb.vinculoempregaticio.VinculoEmpregaticioHome)so.servant).findAllVinculosEmpregaticios();
