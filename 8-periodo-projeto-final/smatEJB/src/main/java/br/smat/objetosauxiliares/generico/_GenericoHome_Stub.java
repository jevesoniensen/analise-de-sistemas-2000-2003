...
public class _GenericoHome_Stub extends Stub implements GenericoHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.objetosauxiliares.generico.GenericoHome:0000000000000000", 
    ...
    public Generico create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (Generico) in.read_Object(Generico.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.objetosauxiliares.generico.GenericoHome.class);
            if (so == null) {
                return create();
            }
            try {
                Generico result = ((br.smat.objetosauxiliares.generico.GenericoHome)so.servant).create();
                return (Generico)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
