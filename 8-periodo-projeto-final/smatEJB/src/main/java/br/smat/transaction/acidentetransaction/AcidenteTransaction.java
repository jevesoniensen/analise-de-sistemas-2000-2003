...
/**
 * Remote interface for Enterprise Bean: AcidenteTransaction
 */
public interface AcidenteTransaction extends javax.ejb.EJBObject {
	...
	public void save() throws java.rmi.RemoteException,Exception;
}
