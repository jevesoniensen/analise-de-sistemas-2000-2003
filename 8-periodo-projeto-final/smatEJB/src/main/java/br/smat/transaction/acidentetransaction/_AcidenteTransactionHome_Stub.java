...
public class _AcidenteTransactionHome_Stub extends Stub implements AcidenteTransactionHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.transaction.acidentetransaction.AcidenteTransactionHome:0000000000000000", 
    ...
    public AcidenteTransaction create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (AcidenteTransaction) in.read_Object(AcidenteTransaction.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.transaction.acidentetransaction.AcidenteTransactionHome.class);
            if (so == null) {
                return create();
            }
            try {
                AcidenteTransaction result = ((br.smat.transaction.acidentetransaction.AcidenteTransactionHome)so.servant).create();
                return (AcidenteTransaction)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
