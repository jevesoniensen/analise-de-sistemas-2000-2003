...
public class _EmpregadorTransactionHome_Stub extends Stub implements EmpregadorTransactionHome {
    
    private static final String[] _type_ids = {
        "RMI:br.smat.transaction.empregadortransaction.EmpregadorTransactionHome:0000000000000000", 
    ...
    public EmpregadorTransaction create() throws CreateException, RemoteException {
        if (!Util.isLocal(this)) {
            try {
                org.omg.CORBA_2_3.portable.InputStream in = null;
                try {
                    ...
                    in = (org.omg.CORBA_2_3.portable.InputStream)_invoke(out);
                    return (EmpregadorTransaction) in.read_Object(EmpregadorTransaction.class);
                } catch (ApplicationException ex) {
                    in = (org.omg.CORBA_2_3.portable.InputStream) ex.getInputStream();
                    String id = in.read_string();
            ...
            ServantObject so = _servant_preinvoke("create",br.smat.transaction.empregadortransaction.EmpregadorTransactionHome.class);
            if (so == null) {
                return create();
            }
            try {
                EmpregadorTransaction result = ((br.smat.transaction.empregadortransaction.EmpregadorTransactionHome)so.servant).create();
                return (EmpregadorTransaction)Util.copyObject(result,_orb());
            } catch (Throwable ex) {
                Throwable exCopy = (Throwable)Util.copyObject(ex,_orb());
